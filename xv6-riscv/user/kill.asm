...
main(int argc, char **argv)
{
  ...
  44:	89058593          	addi	a1,a1,-1904 # 8d0 <malloc+0xfe>
  48:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e6:	50e50513          	addi	a0,a0,1294 # 8f0 <digits>
 3ea:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 47a:	26090863          	beqz	s2,6ea <vprintf+0x27e>
 ...
 4c2:	20090c63          	beqz	s2,6da <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
 ...
 4e4:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 4e8:	03878f63          	beq	a5,s8,526 <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
 4ec:	05978963          	beq	a5,s9,53e <vprintf+0xd2>
 ...
 4f4:	0ee78363          	beq	a5,a4,5da <vprintf+0x16e>
 ...
 4fc:	12e78563          	beq	a5,a4,626 <vprintf+0x1ba>
 ...
 504:	14e78a63          	beq	a5,a4,658 <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
 508:	07300713          	li	a4,115
 50c:	18e78a63          	beq	a5,a4,6a0 <vprintf+0x234>
 ...
 514:	04e79563          	bne	a5,a4,55e <vprintf+0xf2>
        putc(fd, '%');
 518:	02500593          	li	a1,37
 51c:	855a                	mv	a0,s6
 51e:	e89ff0ef          	jal	3a6 <putc>
 ...
 532:	855a                	mv	a0,s6
 534:	e91ff0ef          	jal	3c4 <printint>
 538:	8bca                	mv	s7,s2
      state = 0;
 53a:	4981                	li	s3,0
 53c:	bfad                	j	4b6 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
 53e:	06400793          	li	a5,100
 542:	02f68963          	beq	a3,a5,574 <vprintf+0x108>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 546:	06c00793          	li	a5,108
 54a:	04f68263          	beq	a3,a5,58e <vprintf+0x122>
      } else if(c0 == 'l' && c1 == 'u'){
 54e:	07500793          	li	a5,117
 552:	0af68063          	beq	a3,a5,5f2 <vprintf+0x186>
      } else if(c0 == 'l' && c1 == 'x'){
 556:	07800793          	li	a5,120
 55a:	0ef68263          	beq	a3,a5,63e <vprintf+0x1d2>
        putc(fd, '%');
 55e:	02500593          	li	a1,37
 562:	855a                	mv	a0,s6
 564:	e43ff0ef          	jal	3a6 <putc>
        putc(fd, c0);
 568:	85ca                	mv	a1,s2
 56a:	855a                	mv	a0,s6
 ...
 58a:	4981                	li	s3,0
        i += 1;
 58c:	b72d                	j	4b6 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 58e:	06400793          	li	a5,100
 592:	02f60763          	beq	a2,a5,5c0 <vprintf+0x154>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 596:	07500793          	li	a5,117
 59a:	06f60963          	beq	a2,a5,60c <vprintf+0x1a0>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 59e:	07800793          	li	a5,120
 5a2:	faf61ee3          	bne	a2,a5,55e <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 5e6:	855a                	mv	a0,s6
 5e8:	dddff0ef          	jal	3c4 <printint>
 5ec:	8bca                	mv	s7,s2
      state = 0;
 5ee:	4981                	li	s3,0
 5f0:	b5d9                	j	4b6 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 632:	855a                	mv	a0,s6
 634:	d91ff0ef          	jal	3c4 <printint>
 638:	8bca                	mv	s7,s2
      state = 0;
 63a:	4981                	li	s3,0
 63c:	bdad                	j	4b6 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 666:	855a                	mv	a0,s6
 668:	d3fff0ef          	jal	3a6 <putc>
  putc(fd, 'x');
 66c:	07800593          	li	a1,120
 670:	855a                	mv	a0,s6
 672:	d35ff0ef          	jal	3a6 <putc>
 676:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 678:	00000b97          	auipc	s7,0x0
 67c:	278b8b93          	addi	s7,s7,632 # 8f0 <digits>
 680:	03c9d793          	srli	a5,s3,0x3c
 684:	97de                	add	a5,a5,s7
 686:	0007c583          	lbu	a1,0(a5)
 68a:	855a                	mv	a0,s6
 68c:	d1bff0ef          	jal	3a6 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 690:	0992                	slli	s3,s3,0x4
 692:	397d                	addiw	s2,s2,-1
 694:	fe0916e3          	bnez	s2,680 <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
 698:	8bea                	mv	s7,s10
      state = 0;
 69a:	4981                	li	s3,0
 69c:	6d02                	ld	s10,0(sp)
 69e:	bd21                	j	4b6 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
 6a0:	008b8993          	addi	s3,s7,8
 6a4:	000bb903          	ld	s2,0(s7)
 6a8:	00090f63          	beqz	s2,6c6 <vprintf+0x25a>
        for(; *s; s++)
 6ac:	00094583          	lbu	a1,0(s2)
 6b0:	c195                	beqz	a1,6d4 <vprintf+0x268>
          putc(fd, *s);
 6b2:	855a                	mv	a0,s6
 6b4:	cf3ff0ef          	jal	3a6 <putc>
        for(; *s; s++)
 6b8:	0905                	addi	s2,s2,1
 6ba:	00094583          	lbu	a1,0(s2)
 6be:	f9f5                	bnez	a1,6b2 <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
 6c0:	8bce                	mv	s7,s3
      state = 0;
 6c2:	4981                	li	s3,0
 6c4:	bbcd                	j	4b6 <vprintf+0x4a>
          s = "(null)";
 6c6:	00000917          	auipc	s2,0x0
 6ca:	22290913          	addi	s2,s2,546 # 8e8 <malloc+0x116>
        for(; *s; s++)
 6ce:	02800593          	li	a1,40
 6d2:	b7c5                	j	6b2 <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
 6d4:	8bce                	mv	s7,s3
      state = 0;
 6d6:	4981                	li	s3,0
 6d8:	bbf9                	j	4b6 <vprintf+0x4a>
...
malloc(uint nbytes)
{
 ...
 7f8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 7fa:	4798                	lw	a4,8(a5)
 7fc:	08977a63          	bgeu	a4,s1,890 <malloc+0xbe>
 ...
 84a:	6398                	ld	a4,0(a5)
 84c:	e118                	sd	a4,0(a0)
 84e:	a8a9                	j	8a8 <malloc+0xd6>
  hp->s.size = nu;
 850:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 854:	0541                	addi	a0,a0,16
 856:	efbff0ef          	jal	750 <free>
  return freep;
 85a:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 85e:	c12d                	beqz	a0,8c0 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 860:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 862:	4798                	lw	a4,8(a5)
 864:	02977263          	bgeu	a4,s1,888 <malloc+0xb6>
    if(p == freep)
 868:	00093703          	ld	a4,0(s2)
 86c:	853e                	mv	a0,a5
 86e:	fef719e3          	bne	a4,a5,860 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
 872:	8552                	mv	a0,s4
 874:	ad3ff0ef          	jal	346 <sbrk>
  if(p == (char*)-1)
 878:	fd551ce3          	bne	a0,s5,850 <malloc+0x7e>
        return 0;
 87c:	4501                	li	a0,0
 ...
 882:	6aa2                	ld	s5,8(sp)
 884:	6b02                	ld	s6,0(sp)
 886:	a03d                	j	8b4 <malloc+0xe2>
 888:	7902                	ld	s2,32(sp)
 88a:	6a42                	ld	s4,16(sp)
 88c:	6aa2                	ld	s5,8(sp)
 88e:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
 890:	fae48de3          	beq	s1,a4,84a <malloc+0x78>
        p->s.size -= nunits;
