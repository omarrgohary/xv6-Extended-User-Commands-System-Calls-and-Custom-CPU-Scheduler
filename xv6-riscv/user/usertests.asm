...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	41a78793          	addi	a5,a5,1050 # 7428 <malloc+0x2494>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	02a50513          	addi	a0,a0,42 # 5090 <malloc+0xfc>
      6e:	673040ef          	jal	4ee0 <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	01050513          	addi	a0,a0,16 # 50b0 <malloc+0x11c>
      a8:	639040ef          	jal	4ee0 <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	00850513          	addi	a0,a0,8 # 50c8 <malloc+0x134>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	01250513          	addi	a0,a0,18 # 50e8 <malloc+0x154>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	fde50513          	addi	a0,a0,-34 # 50d0 <malloc+0x13c>
      fa:	5e7040ef          	jal	4ee0 <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	ff250513          	addi	a0,a0,-14 # 50f8 <malloc+0x164>
     10e:	5d3040ef          	jal	4ee0 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	fa450513          	addi	a0,a0,-92 # 5120 <malloc+0x18c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	f9a50513          	addi	a0,a0,-102 # 5140 <malloc+0x1ac>
     1ae:	533040ef          	jal	4ee0 <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	f2450513          	addi	a0,a0,-220 # 5168 <malloc+0x1d4>
     24c:	085040ef          	jal	4ad0 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	f14a8a93          	addi	s5,s5,-236 # 5168 <malloc+0x1d4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	eb650513          	addi	a0,a0,-330 # 5178 <malloc+0x1e4>
     2ca:	417040ef          	jal	4ee0 <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	ebc50513          	addi	a0,a0,-324 # 5198 <malloc+0x204>
     2e4:	3fd040ef          	jal	4ee0 <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	eb250513          	addi	a0,a0,-334 # 51b0 <malloc+0x21c>
     306:	7ca040ef          	jal	4ad0 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	ea298993          	addi	s3,s3,-350 # 51b0 <malloc+0x21c>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	e6650513          	addi	a0,a0,-410 # 51b0 <malloc+0x21c>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	dda58593          	addi	a1,a1,-550 # 5138 <malloc+0x1a4>
     366:	73a040ef          	jal	4aa0 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	e6050513          	addi	a0,a0,-416 # 51d0 <malloc+0x23c>
     378:	369040ef          	jal	4ee0 <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	702040ef          	jal	4a80 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	e3650513          	addi	a0,a0,-458 # 51b8 <malloc+0x224>
     38a:	357040ef          	jal	4ee0 <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	6f0040ef          	jal	4a80 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	e2450513          	addi	a0,a0,-476 # 51b8 <malloc+0x224>
     39c:	345040ef          	jal	4ee0 <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b0:	e0450513          	addi	a0,a0,-508 # 51b0 <malloc+0x21c>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	f9878793          	addi	a5,a5,-104 # 7428 <malloc+0x2494>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	d22a0a13          	addi	s4,s4,-734 # 51e0 <malloc+0x24c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	ca450513          	addi	a0,a0,-860 # 51e8 <malloc+0x254>
     54c:	195040ef          	jal	4ee0 <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	ca650513          	addi	a0,a0,-858 # 5200 <malloc+0x26c>
     562:	17f040ef          	jal	4ee0 <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	cc050513          	addi	a0,a0,-832 # 5230 <malloc+0x29c>
     578:	169040ef          	jal	4ee0 <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	502040ef          	jal	4a80 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	cde50513          	addi	a0,a0,-802 # 5260 <malloc+0x2cc>
     58a:	157040ef          	jal	4ee0 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	cd850513          	addi	a0,a0,-808 # 5270 <malloc+0x2dc>
     5a0:	141040ef          	jal	4ee0 <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	e6a78793          	addi	a5,a5,-406 # 7428 <malloc+0x2494>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	caea0a13          	addi	s4,s4,-850 # 52a0 <malloc+0x30c>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	b3ea8a93          	addi	s5,s5,-1218 # 5138 <malloc+0x1a4>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	c2a50513          	addi	a0,a0,-982 # 52a8 <malloc+0x314>
     686:	05b040ef          	jal	4ee0 <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	c2c50513          	addi	a0,a0,-980 # 52c0 <malloc+0x32c>
     69c:	045040ef          	jal	4ee0 <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	3de040ef          	jal	4a80 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	bba50513          	addi	a0,a0,-1094 # 5260 <malloc+0x2cc>
     6ae:	033040ef          	jal	4ee0 <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	3cc040ef          	jal	4a80 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	c3850513          	addi	a0,a0,-968 # 52f0 <malloc+0x35c>
     6c0:	021040ef          	jal	4ee0 <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	c3a50513          	addi	a0,a0,-966 # 5308 <malloc+0x374>
     6d6:	00b040ef          	jal	4ee0 <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     6f8:	a2c50513          	addi	a0,a0,-1492 # 5120 <malloc+0x18c>
     6fc:	3d4040ef          	jal	4ad0 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     700:	60100593          	li	a1,1537
     704:	00005517          	auipc	a0,0x5
     708:	a1c50513          	addi	a0,a0,-1508 # 5120 <malloc+0x18c>
     70c:	3b4040ef          	jal	4ac0 <open>
     710:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     712:	4611                	li	a2,4
     714:	00005597          	auipc	a1,0x5
     718:	a1c58593          	addi	a1,a1,-1508 # 5130 <malloc+0x19c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	9f850513          	addi	a0,a0,-1544 # 5120 <malloc+0x18c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	9d450513          	addi	a0,a0,-1580 # 5120 <malloc+0x18c>
     754:	36c040ef          	jal	4ac0 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	9c450513          	addi	a0,a0,-1596 # 5120 <malloc+0x18c>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	c0a58593          	addi	a1,a1,-1014 # 5398 <malloc+0x404>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	95c50513          	addi	a0,a0,-1700 # 5120 <malloc+0x18c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	b4050513          	addi	a0,a0,-1216 # 5338 <malloc+0x3a4>
     800:	6e0040ef          	jal	4ee0 <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	b4c50513          	addi	a0,a0,-1204 # 5358 <malloc+0x3c4>
     814:	6cc040ef          	jal	4ee0 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	b4c50513          	addi	a0,a0,-1204 # 5368 <malloc+0x3d4>
     824:	6bc040ef          	jal	4ee0 <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	b5850513          	addi	a0,a0,-1192 # 5388 <malloc+0x3f4>
     838:	6a8040ef          	jal	4ee0 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	b2850513          	addi	a0,a0,-1240 # 5368 <malloc+0x3d4>
     848:	698040ef          	jal	4ee0 <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	b4a50513          	addi	a0,a0,-1206 # 53a0 <malloc+0x40c>
     85e:	682040ef          	jal	4ee0 <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	b5450513          	addi	a0,a0,-1196 # 53c0 <malloc+0x42c>
     874:	66c040ef          	jal	4ee0 <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	b4850513          	addi	a0,a0,-1208 # 53e0 <malloc+0x44c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	b5c98993          	addi	s3,s3,-1188 # 5408 <malloc+0x474>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	b8ca8a93          	addi	s5,s5,-1140 # 5440 <malloc+0x4ac>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	af250513          	addi	a0,a0,-1294 # 53e0 <malloc+0x44c>
  ...
  if(unlink("small") < 0){
     ...
     922:	ac250513          	addi	a0,a0,-1342 # 53e0 <malloc+0x44c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	aa450513          	addi	a0,a0,-1372 # 53e8 <malloc+0x454>
     94c:	594040ef          	jal	4ee0 <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	abe50513          	addi	a0,a0,-1346 # 5418 <malloc+0x484>
     962:	57e040ef          	jal	4ee0 <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	ae050513          	addi	a0,a0,-1312 # 5450 <malloc+0x4bc>
     978:	568040ef          	jal	4ee0 <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	af450513          	addi	a0,a0,-1292 # 5478 <malloc+0x4e4>
     98c:	554040ef          	jal	4ee0 <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	b0050513          	addi	a0,a0,-1280 # 5498 <malloc+0x504>
     9a0:	540040ef          	jal	4ee0 <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	b0450513          	addi	a0,a0,-1276 # 54b0 <malloc+0x51c>
     9b4:	52c040ef          	jal	4ee0 <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	afa50513          	addi	a0,a0,-1286 # 54d0 <malloc+0x53c>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	ab450513          	addi	a0,a0,-1356 # 54d0 <malloc+0x53c>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	a7c50513          	addi	a0,a0,-1412 # 54d8 <malloc+0x544>
     a64:	47c040ef          	jal	4ee0 <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	a8650513          	addi	a0,a0,-1402 # 54f8 <malloc+0x564>
     a7a:	466040ef          	jal	4ee0 <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	a9a50513          	addi	a0,a0,-1382 # 5520 <malloc+0x58c>
     a8e:	452040ef          	jal	4ee0 <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aaa:	a2a50513          	addi	a0,a0,-1494 # 54d0 <malloc+0x53c>
     ...
     ad0:	a7450513          	addi	a0,a0,-1420 # 5540 <malloc+0x5ac>
     ad4:	40c040ef          	jal	4ee0 <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	a8650513          	addi	a0,a0,-1402 # 5568 <malloc+0x5d4>
     aea:	3f6040ef          	jal	4ee0 <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	a8850513          	addi	a0,a0,-1400 # 5580 <malloc+0x5ec>
     b00:	3e0040ef          	jal	4ee0 <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	a9c50513          	addi	a0,a0,-1380 # 55a8 <malloc+0x614>
     b14:	3cc040ef          	jal	4ee0 <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	a8e50513          	addi	a0,a0,-1394 # 55c0 <malloc+0x62c>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	aaa58593          	addi	a1,a1,-1366 # 55f0 <malloc+0x65c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	a6650513          	addi	a0,a0,-1434 # 55c0 <malloc+0x62c>
  ...
  unlink("unlinkread");
     ...
     be6:	9de50513          	addi	a0,a0,-1570 # 55c0 <malloc+0x62c>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	9d250513          	addi	a0,a0,-1582 # 55d0 <malloc+0x63c>
     c06:	2da040ef          	jal	4ee0 <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	9e650513          	addi	a0,a0,-1562 # 55f8 <malloc+0x664>
     c1a:	2c6040ef          	jal	4ee0 <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	9f250513          	addi	a0,a0,-1550 # 5618 <malloc+0x684>
     c2e:	2b2040ef          	jal	4ee0 <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	a0650513          	addi	a0,a0,-1530 # 5640 <malloc+0x6ac>
     c42:	29e040ef          	jal	4ee0 <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	a1250513          	addi	a0,a0,-1518 # 5660 <malloc+0x6cc>
     c56:	28a040ef          	jal	4ee0 <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	a1e50513          	addi	a0,a0,-1506 # 5680 <malloc+0x6ec>
     c6a:	276040ef          	jal	4ee0 <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	a1e50513          	addi	a0,a0,-1506 # 56a0 <malloc+0x70c>
     c8a:	647030ef          	jal	4ad0 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	a1a50513          	addi	a0,a0,-1510 # 56a8 <malloc+0x714>
     c96:	63b030ef          	jal	4ad0 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	a0250513          	addi	a0,a0,-1534 # 56a0 <malloc+0x70c>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	93e58593          	addi	a1,a1,-1730 # 55f0 <malloc+0x65c>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	92650513          	addi	a0,a0,-1754 # 56b0 <malloc+0x71c>
     d92:	14e040ef          	jal	4ee0 <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	92a50513          	addi	a0,a0,-1750 # 56c8 <malloc+0x734>
     da6:	13a040ef          	jal	4ee0 <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	92e50513          	addi	a0,a0,-1746 # 56e0 <malloc+0x74c>
     dba:	126040ef          	jal	4ee0 <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	93a50513          	addi	a0,a0,-1734 # 5700 <malloc+0x76c>
     dce:	112040ef          	jal	4ee0 <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	95650513          	addi	a0,a0,-1706 # 5730 <malloc+0x79c>
     de2:	0fe040ef          	jal	4ee0 <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	95a50513          	addi	a0,a0,-1702 # 5748 <malloc+0x7b4>
     df6:	0ea040ef          	jal	4ee0 <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	95e50513          	addi	a0,a0,-1698 # 5760 <malloc+0x7cc>
     e0a:	0d6040ef          	jal	4ee0 <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	97250513          	addi	a0,a0,-1678 # 5788 <malloc+0x7f4>
     e1e:	0c2040ef          	jal	4ee0 <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	98e50513          	addi	a0,a0,-1650 # 57b8 <malloc+0x824>
     e32:	0ae040ef          	jal	4ee0 <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	98498993          	addi	s3,s3,-1660 # 57d8 <malloc+0x844>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	95c50513          	addi	a0,a0,-1700 # 57e8 <malloc+0x854>
     e94:	04c040ef          	jal	4ee0 <printf>
      exit(1);
     e98:	4505                	li	a0,1
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	95450513          	addi	a0,a0,-1708 # 5808 <malloc+0x874>
     ebc:	415030ef          	jal	4ad0 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	94450513          	addi	a0,a0,-1724 # 5808 <malloc+0x874>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	92aa0a13          	addi	s4,s4,-1750 # 5808 <malloc+0x874>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	8dc50513          	addi	a0,a0,-1828 # 5808 <malloc+0x874>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	87c50513          	addi	a0,a0,-1924 # 5810 <malloc+0x87c>
     f9c:	745030ef          	jal	4ee0 <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	88250513          	addi	a0,a0,-1918 # 5830 <malloc+0x89c>
     fb6:	72b030ef          	jal	4ee0 <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	89650513          	addi	a0,a0,-1898 # 5858 <malloc+0x8c4>
     fca:	717030ef          	jal	4ee0 <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000001000 <badarg>:
{
    ...
    101e:	0ae98993          	addi	s3,s3,174 # 50c8 <malloc+0x134>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	91878793          	addi	a5,a5,-1768 # 69a8 <malloc+0x1a14>
  ...
  if(pid == 0){
    ...
    10e8:	34478793          	addi	a5,a5,836 # 7428 <malloc+0x2494>
    ...
    110c:	fc050513          	addi	a0,a0,-64 # 50c8 <malloc+0x134>
    ...
    1120:	7e450513          	addi	a0,a0,2020 # 5900 <malloc+0x96c>
    1124:	5bd030ef          	jal	4ee0 <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	74450513          	addi	a0,a0,1860 # 5878 <malloc+0x8e4>
    113c:	5a5030ef          	jal	4ee0 <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	74c50513          	addi	a0,a0,1868 # 5898 <malloc+0x904>
    1154:	58d030ef          	jal	4ee0 <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	75250513          	addi	a0,a0,1874 # 58b8 <malloc+0x924>
    116e:	573030ef          	jal	4ee0 <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	76250513          	addi	a0,a0,1890 # 58e0 <malloc+0x94c>
    1186:	55b030ef          	jal	4ee0 <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	0f5030ef          	jal	4a80 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	d3850513          	addi	a0,a0,-712 # 6ec8 <malloc+0x1f34>
    1198:	549030ef          	jal	4ee0 <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	75e50513          	addi	a0,a0,1886 # 5928 <malloc+0x994>
    11d2:	50f030ef          	jal	4ee0 <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	f3450513          	addi	a0,a0,-204 # 5120 <malloc+0x18c>
  ...
  if(pid == 0){
    ...
    1216:	f0ea0a13          	addi	s4,s4,-242 # 5120 <malloc+0x18c>
      int n = write(fd, "1234567890", 10);
    121a:	00004a97          	auipc	s5,0x4
    121e:	76ea8a93          	addi	s5,s5,1902 # 5988 <malloc+0x9f4>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	6e250513          	addi	a0,a0,1762 # 5958 <malloc+0x9c4>
    127e:	463030ef          	jal	4ee0 <printf>
    exit(1);
    1282:	4505                	li	a0,1
    ...
    128e:	6e650513          	addi	a0,a0,1766 # 5970 <malloc+0x9dc>
    1292:	44f030ef          	jal	4ee0 <printf>
        exit(1);
    1296:	4505                	li	a0,1
    ...
    12a4:	6f850513          	addi	a0,a0,1784 # 5998 <malloc+0xa04>
    12a8:	439030ef          	jal	4ee0 <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    ...
    12c2:	e62a0a13          	addi	s4,s4,-414 # 5120 <malloc+0x18c>
    int n = write(fd, "xxx", 3);
    12c6:	00004a97          	auipc	s5,0x4
    12ca:	6f2a8a93          	addi	s5,s5,1778 # 59b8 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	e2050513          	addi	a0,a0,-480 # 5120 <malloc+0x18c>
  ...
  exit(xstatus);
    ...
    131a:	65a50513          	addi	a0,a0,1626 # 5970 <malloc+0x9dc>
    131e:	3c3030ef          	jal	4ee0 <printf>
      exit(1);
    1322:	4505                	li	a0,1
    ...
    1330:	69450513          	addi	a0,a0,1684 # 59c0 <malloc+0xa2c>
    1334:	3ad030ef          	jal	4ee0 <printf>
      exit(1);
    1338:	4505                	li	a0,1
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	d7e78793          	addi	a5,a5,-642 # 50c8 <malloc+0x134>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00004797          	auipc	a5,0x4
    135a:	68a78793          	addi	a5,a5,1674 # 59e0 <malloc+0xa4c>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00004517          	auipc	a0,0x4
    136a:	68250513          	addi	a0,a0,1666 # 59e8 <malloc+0xa54>
  ...
  if(pid == 0) {
    ...
    138e:	65e50513          	addi	a0,a0,1630 # 59e8 <malloc+0xa54>
    ...
    13a6:	66650513          	addi	a0,a0,1638 # 5a08 <malloc+0xa74>
    13aa:	337030ef          	jal	4ee0 <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    ...
    13bc:	5a050513          	addi	a0,a0,1440 # 5958 <malloc+0x9c4>
    13c0:	321030ef          	jal	4ee0 <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    ...
    13d0:	62450513          	addi	a0,a0,1572 # 59f0 <malloc+0xa5c>
    13d4:	30d030ef          	jal	4ee0 <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    ...
    13e6:	ce650513          	addi	a0,a0,-794 # 50c8 <malloc+0x134>
  ...
  if(xstatus != 0)
    ...
    140e:	60e50513          	addi	a0,a0,1550 # 5a18 <malloc+0xa84>
    1412:	2cf030ef          	jal	4ee0 <printf>
      exit(1);
    1416:	4505                	li	a0,1
    ...
    1422:	61250513          	addi	a0,a0,1554 # 5a30 <malloc+0xa9c>
    1426:	2bb030ef          	jal	4ee0 <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00004517          	auipc	a0,0x4
    1432:	5ba50513          	addi	a0,a0,1466 # 59e8 <malloc+0xa54>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	04850513          	addi	a0,a0,72 # 5498 <malloc+0x504>
    1458:	289030ef          	jal	4ee0 <printf>
    exit(1);
    145c:	4505                	li	a0,1
    ...
    1468:	50c50513          	addi	a0,a0,1292 # 5970 <malloc+0x9dc>
    146c:	275030ef          	jal	4ee0 <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	60e030ef          	jal	4a80 <exit>
  unlink("echo-ok");
    1476:	00004517          	auipc	a0,0x4
    147a:	57250513          	addi	a0,a0,1394 # 59e8 <malloc+0xa54>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	5ac50513          	addi	a0,a0,1452 # 5a48 <malloc+0xab4>
    14a4:	23d030ef          	jal	4ee0 <printf>
    exit(1);
    14a8:	4505                	li	a0,1
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	51850513          	addi	a0,a0,1304 # 5a60 <malloc+0xacc>
    1550:	191030ef          	jal	4ee0 <printf>
    exit(1);
    1554:	4505                	li	a0,1
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	4b650513          	addi	a0,a0,1206 # 5a78 <malloc+0xae4>
    15ca:	117030ef          	jal	4ee0 <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    ...
    15da:	4ba50513          	addi	a0,a0,1210 # 5a90 <malloc+0xafc>
    15de:	103030ef          	jal	4ee0 <printf>
          return;
    ...
    160a:	4a250513          	addi	a0,a0,1186 # 5aa8 <malloc+0xb14>
    160e:	0d3030ef          	jal	4ee0 <printf>
      exit(1);
    1612:	4505                	li	a0,1
    ...
    1642:	48a50513          	addi	a0,a0,1162 # 5ac8 <malloc+0xb34>
    1646:	09b030ef          	jal	4ee0 <printf>
    exit(1);
    164a:	4505                	li	a0,1
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	2b850513          	addi	a0,a0,696 # 5958 <malloc+0x9c4>
    16a8:	039030ef          	jal	4ee0 <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    ...
    16b8:	42c50513          	addi	a0,a0,1068 # 5ae0 <malloc+0xb4c>
    16bc:	025030ef          	jal	4ee0 <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    ...
    16cc:	43050513          	addi	a0,a0,1072 # 5af8 <malloc+0xb64>
    16d0:	011030ef          	jal	4ee0 <printf>
        exit(1);
    16d4:	4505                	li	a0,1
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	23450513          	addi	a0,a0,564 # 5958 <malloc+0x9c4>
    172c:	7b4030ef          	jal	4ee0 <printf>
      exit(1);
    1730:	4505                	li	a0,1
    ...
    1740:	21c50513          	addi	a0,a0,540 # 5958 <malloc+0x9c4>
    1744:	79c030ef          	jal	4ee0 <printf>
        exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <forkfork>:
{
    ...
    179e:	37e50513          	addi	a0,a0,894 # 5b18 <malloc+0xb84>
    17a2:	73e030ef          	jal	4ee0 <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	2d8030ef          	jal	4a80 <exit>
{
    ...
    17da:	35250513          	addi	a0,a0,850 # 5b28 <malloc+0xb94>
    17de:	702030ef          	jal	4ee0 <printf>
      exit(1);
    17e2:	4505                	li	a0,1
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	6b850513          	addi	a0,a0,1720 # 6ec8 <malloc+0x1f34>
    1818:	6c8030ef          	jal	4ee0 <printf>
      exit(1);
    181c:	4505                	li	a0,1
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	0c650513          	addi	a0,a0,198 # 5958 <malloc+0x9c4>
    189a:	646030ef          	jal	4ee0 <printf>
      exit(1);
    189e:	4505                	li	a0,1
    ...
    18ba:	13a50513          	addi	a0,a0,314 # 59f0 <malloc+0xa5c>
    18be:	622030ef          	jal	4ee0 <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    ...
    1918:	23450513          	addi	a0,a0,564 # 5b48 <malloc+0xbb4>
    191c:	5c4030ef          	jal	4ee0 <printf>
            exit(1);
    1920:	4505                	li	a0,1
    ...
    193c:	22850513          	addi	a0,a0,552 # 5b60 <malloc+0xbcc>
    1940:	5a0030ef          	jal	4ee0 <printf>
        exit(1);
    1944:	4505                	li	a0,1
    ...
    198e:	1fe50513          	addi	a0,a0,510 # 5b88 <malloc+0xbf4>
    1992:	54e030ef          	jal	4ee0 <printf>
        exit(1);
    1996:	4505                	li	a0,1
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	71450513          	addi	a0,a0,1812 # 5138 <malloc+0x1a4>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	6e0b0b13          	addi	s6,s6,1760 # 5138 <malloc+0x1a4>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	150c0c13          	addi	s8,s8,336 # 5bb0 <malloc+0xc1c>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	eec50513          	addi	a0,a0,-276 # 5958 <malloc+0x9c4>
    1a74:	46c030ef          	jal	4ee0 <printf>
    exit(1);
    1a78:	4505                	li	a0,1
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	0f450513          	addi	a0,a0,244 # 5c00 <malloc+0xc6c>
    1b14:	3cc030ef          	jal	4ee0 <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    ...
    1b28:	09450513          	addi	a0,a0,148 # 5bb8 <malloc+0xc24>
    1b2c:	3b4030ef          	jal	4ee0 <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    ...
    1b3c:	09850513          	addi	a0,a0,152 # 5bd0 <malloc+0xc3c>
    1b40:	3a0030ef          	jal	4ee0 <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    ...
    1b50:	09c50513          	addi	a0,a0,156 # 5be8 <malloc+0xc54>
    1b54:	38c030ef          	jal	4ee0 <printf>
    exit(1);
    1b58:	4505                	li	a0,1
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	d6e50513          	addi	a0,a0,-658 # 5958 <malloc+0x9c4>
    1bf2:	2ee030ef          	jal	4ee0 <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    ...
    1c08:	02450513          	addi	a0,a0,36 # 5c28 <malloc+0xc94>
    1c0c:	2d4030ef          	jal	4ee0 <printf>
      exit(1);
    1c10:	4505                	li	a0,1
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	ce650513          	addi	a0,a0,-794 # 5958 <malloc+0x9c4>
    1c7a:	266030ef          	jal	4ee0 <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    ...
    1c9a:	fb250513          	addi	a0,a0,-78 # 5c48 <malloc+0xcb4>
    1c9e:	242030ef          	jal	4ee0 <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	f7a50513          	addi	a0,a0,-134 # 5c60 <malloc+0xccc>
    1cee:	1f2030ef          	jal	4ee0 <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    ...
    1cfe:	c5e50513          	addi	a0,a0,-930 # 5958 <malloc+0x9c4>
    1d02:	1de030ef          	jal	4ee0 <printf>
    exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	70678793          	addi	a5,a5,1798 # 7428 <malloc+0x2494>
  ...
  exit(0);
    ...
    1d8e:	efe50513          	addi	a0,a0,-258 # 5c88 <malloc+0xcf4>
    1d92:	14e030ef          	jal	4ee0 <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    ...
    1da2:	bba50513          	addi	a0,a0,-1094 # 5958 <malloc+0x9c4>
    1da6:	13a030ef          	jal	4ee0 <printf>
      exit(1);
    1daa:	4505                	li	a0,1
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	0be50513          	addi	a0,a0,190 # 6ec8 <malloc+0x1f34>
    1e12:	0ce030ef          	jal	4ee0 <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    ...
    1ea0:	e0c50513          	addi	a0,a0,-500 # 5ca8 <malloc+0xd14>
    1ea4:	03c030ef          	jal	4ee0 <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    ...
    1eb8:	2e450513          	addi	a0,a0,740 # 5198 <malloc+0x204>
    1ebc:	024030ef          	jal	4ee0 <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	a8078793          	addi	a5,a5,-1408 # 69a8 <malloc+0x1a14>
  ...
  if(ret != -1){
    ...
    1f66:	d5e50513          	addi	a0,a0,-674 # 5cc0 <malloc+0xd2c>
    1f6a:	777020ef          	jal	4ee0 <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7c:	90050513          	addi	a0,a0,-1792 # 5878 <malloc+0x8e4>
    1f80:	761020ef          	jal	4ee0 <printf>
    exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f92:	90a50513          	addi	a0,a0,-1782 # 5898 <malloc+0x904>
    1f96:	74b020ef          	jal	4ee0 <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	91250513          	addi	a0,a0,-1774 # 58b8 <malloc+0x924>
    1fae:	733020ef          	jal	4ee0 <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    ...
    1fc0:	92450513          	addi	a0,a0,-1756 # 58e0 <malloc+0x94c>
    1fc4:	71d020ef          	jal	4ee0 <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	d0850513          	addi	a0,a0,-760 # 5d00 <malloc+0xd6c>
  ...
  if(n >= 0){
    ...
    2024:	d0050513          	addi	a0,a0,-768 # 5d20 <malloc+0xd8c>
    2028:	6b9020ef          	jal	4ee0 <printf>
    exit(1);
    202c:	4505                	li	a0,1
    ...
    203a:	c9250513          	addi	a0,a0,-878 # 5cc8 <malloc+0xd34>
    203e:	6a3020ef          	jal	4ee0 <printf>
    exit(1);
    2042:	4505                	li	a0,1
    ...
    204e:	c9650513          	addi	a0,a0,-874 # 5ce0 <malloc+0xd4c>
    2052:	68f020ef          	jal	4ee0 <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	229020ef          	jal	4a80 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	cac50513          	addi	a0,a0,-852 # 5d08 <malloc+0xd74>
    2064:	67d020ef          	jal	4ee0 <printf>
    exit(1);
    2068:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2078:	c8c50513          	addi	a0,a0,-884 # 5d00 <malloc+0xd6c>
    207c:	255020ef          	jal	4ad0 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	21e50513          	addi	a0,a0,542 # 52a0 <malloc+0x30c>
  ...
  if(n >= 0){
    ...
    20a8:	cac50513          	addi	a0,a0,-852 # 5d50 <malloc+0xdbc>
    20ac:	635020ef          	jal	4ee0 <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	1cf020ef          	jal	4a80 <exit>
    printf("open(rwsbrk) failed\n");
    20b6:	00004517          	auipc	a0,0x4
    20ba:	c5250513          	addi	a0,a0,-942 # 5d08 <malloc+0xd74>
    20be:	623020ef          	jal	4ee0 <printf>
    exit(1);
    20c2:	4505                	li	a0,1
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	c5850513          	addi	a0,a0,-936 # 5d78 <malloc+0xde4>
    2128:	5b9020ef          	jal	4ee0 <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	c2850513          	addi	a0,a0,-984 # 5d98 <malloc+0xe04>
    2178:	569020ef          	jal	4ee0 <printf>
    exit(1);
    217c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    21c0:	c3c50513          	addi	a0,a0,-964 # 5df8 <malloc+0xe64>
    21c4:	51d020ef          	jal	4ee0 <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    ...
    21da:	be250513          	addi	a0,a0,-1054 # 5db8 <malloc+0xe24>
    21de:	503020ef          	jal	4ee0 <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    ...
    21ee:	bee50513          	addi	a0,a0,-1042 # 5dd8 <malloc+0xe44>
    21f2:	4ef020ef          	jal	4ee0 <printf>
    exit(1);
    21f6:	4505                	li	a0,1
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22f0:	b2c50513          	addi	a0,a0,-1236 # 5e18 <malloc+0xe84>
    22f4:	3ed020ef          	jal	4ee0 <printf>
    exit(1);
    22f8:	4505                	li	a0,1
    ...
    2304:	b6050513          	addi	a0,a0,-1184 # 5e60 <malloc+0xecc>
    2308:	3d9020ef          	jal	4ee0 <printf>
    exit(1);
    230c:	4505                	li	a0,1
    ...
    231c:	b6850513          	addi	a0,a0,-1176 # 5e80 <malloc+0xeec>
    2320:	3c1020ef          	jal	4ee0 <printf>
    exit(1);
    2324:	4505                	li	a0,1
    ...
    2334:	b9050513          	addi	a0,a0,-1136 # 5ec0 <malloc+0xf2c>
    2338:	3a9020ef          	jal	4ee0 <printf>
    exit(1);
    233c:	4505                	li	a0,1
    ...
    2348:	bac50513          	addi	a0,a0,-1108 # 5ef0 <malloc+0xf5c>
    234c:	395020ef          	jal	4ee0 <printf>
    exit(1);
    2350:	4505                	li	a0,1
    ...
    2360:	bcc50513          	addi	a0,a0,-1076 # 5f28 <malloc+0xf94>
    2364:	37d020ef          	jal	4ee0 <printf>
    exit(1);
    2368:	4505                	li	a0,1
...
000000000000236e <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    238e:	bc650513          	addi	a0,a0,-1082 # 5f50 <malloc+0xfbc>
    2392:	72e020ef          	jal	4ac0 <open>
    2396:	84aa                	mv	s1,a0
  unlink("sbrk");
    2398:	00004517          	auipc	a0,0x4
    239c:	bb850513          	addi	a0,a0,-1096 # 5f50 <malloc+0xfbc>
  ...
  if(pipe((int *) a) != 0){
    ...
    23dc:	b8050513          	addi	a0,a0,-1152 # 5f58 <malloc+0xfc4>
    23e0:	301020ef          	jal	4ee0 <printf>
    exit(1);
    23e4:	4505                	li	a0,1
    ...
    23f0:	b8450513          	addi	a0,a0,-1148 # 5f70 <malloc+0xfdc>
    23f4:	2ed020ef          	jal	4ee0 <printf>
    exit(1);
    23f8:	4505                	li	a0,1
    ...
    2404:	66050513          	addi	a0,a0,1632 # 5a60 <malloc+0xacc>
    2408:	2d9020ef          	jal	4ee0 <printf>
    exit(1);
    240c:	4505                	li	a0,1
...
0000000000002412 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2426:	b6650513          	addi	a0,a0,-1178 # 5f88 <malloc+0xff4>
  ...
  close(fd);
    ...
    245e:	51650513          	addi	a0,a0,1302 # 5970 <malloc+0x9dc>
    2462:	27f020ef          	jal	4ee0 <printf>
    exit(1);
    2466:	4505                	li	a0,1
...
000000000000246c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2494:	a3850513          	addi	a0,a0,-1480 # 6ec8 <malloc+0x1f34>
    2498:	249020ef          	jal	4ee0 <printf>
    exit(1);
    249c:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24ce:	9fe50513          	addi	a0,a0,-1538 # 6ec8 <malloc+0x1f34>
    24d2:	20f020ef          	jal	4ee0 <printf>
    exit(1);
    24d6:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    250e:	9be50513          	addi	a0,a0,-1602 # 6ec8 <malloc+0x1f34>
    2512:	1cf020ef          	jal	4ee0 <printf>
    exit(1);
    2516:	4505                	li	a0,1
...
00000000000025f8 <execout>:
{
  ...
  exit(0);
    ...
    262e:	89e50513          	addi	a0,a0,-1890 # 6ec8 <malloc+0x1f34>
    2632:	0af020ef          	jal	4ee0 <printf>
      exit(1);
    2636:	4505                	li	a0,1
    ...
    266e:	a5e50513          	addi	a0,a0,-1442 # 50c8 <malloc+0x134>
    2672:	faa43c23          	sd	a0,-72(s0)
    2676:	00003797          	auipc	a5,0x3
    267a:	ac278793          	addi	a5,a5,-1342 # 5138 <malloc+0x1a4>
...
0000000000002694 <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26c4:	95050513          	addi	a0,a0,-1712 # 6010 <malloc+0x107c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26da:	9b250513          	addi	a0,a0,-1614 # 6088 <malloc+0x10f4>
  ...
  unlink("12345678901234");
    ...
    275e:	83650513          	addi	a0,a0,-1994 # 5f90 <malloc+0xffc>
    2762:	77e020ef          	jal	4ee0 <printf>
    exit(1);
    2766:	4505                	li	a0,1
    ...
    2772:	86a50513          	addi	a0,a0,-1942 # 5fd8 <malloc+0x1044>
    2776:	76a020ef          	jal	4ee0 <printf>
    exit(1);
    277a:	4505                	li	a0,1
    ...
    2786:	8be50513          	addi	a0,a0,-1858 # 6040 <malloc+0x10ac>
    278a:	756020ef          	jal	4ee0 <printf>
    exit(1);
    278e:	4505                	li	a0,1
    ...
    279a:	92250513          	addi	a0,a0,-1758 # 60b8 <malloc+0x1124>
    279e:	742020ef          	jal	4ee0 <printf>
    exit(1);
    27a2:	4505                	li	a0,1
    ...
    27ae:	96e50513          	addi	a0,a0,-1682 # 6118 <malloc+0x1184>
    27b2:	72e020ef          	jal	4ee0 <printf>
    exit(1);
    27b6:	4505                	li	a0,1
    ...
    27c2:	9b250513          	addi	a0,a0,-1614 # 6170 <malloc+0x11dc>
    27c6:	71a020ef          	jal	4ee0 <printf>
    exit(1);
    27ca:	4505                	li	a0,1
...
00000000000027d0 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    280a:	9a250513          	addi	a0,a0,-1630 # 61a8 <malloc+0x1214>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2836:	98650513          	addi	a0,a0,-1658 # 61b8 <malloc+0x1224>
    283a:	6a6020ef          	jal	4ee0 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    28ac:	90050513          	addi	a0,a0,-1792 # 61a8 <malloc+0x1214>
    28b0:	238020ef          	jal	4ae8 <mkdir>
    28b4:	12050063          	beqz	a0,29d4 <diskfull+0x204>
  unlink("diskfulldir");
    28b8:	00004517          	auipc	a0,0x4
    28bc:	8f050513          	addi	a0,a0,-1808 # 61a8 <malloc+0x1214>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29da:	80250513          	addi	a0,a0,-2046 # 61d8 <malloc+0x1244>
    29de:	502020ef          	jal	4ee0 <printf>
...
00000000000029e4 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a40:	7d450513          	addi	a0,a0,2004 # 6210 <malloc+0x127c>
    2a44:	49c020ef          	jal	4ee0 <printf>
    exit(1);
    2a48:	4505                	li	a0,1
    ...
    2a54:	7d850513          	addi	a0,a0,2008 # 6228 <malloc+0x1294>
    2a58:	488020ef          	jal	4ee0 <printf>
    exit(1);
    2a5c:	4505                	li	a0,1
    ...
    2a68:	7f450513          	addi	a0,a0,2036 # 6258 <malloc+0x12c4>
    2a6c:	474020ef          	jal	4ee0 <printf>
    exit(1);
    2a70:	4505                	li	a0,1
    ...
    2a7c:	80850513          	addi	a0,a0,-2040 # 6280 <malloc+0x12ec>
    2a80:	460020ef          	jal	4ee0 <printf>
    exit(1);
    2a84:	4505                	li	a0,1
...
0000000000002a8a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2adc:	e8050513          	addi	a0,a0,-384 # 5958 <malloc+0x9c4>
    2ae0:	400020ef          	jal	4ee0 <printf>
    exit(1);
    2ae4:	4505                	li	a0,1
    ...
    2af0:	72450513          	addi	a0,a0,1828 # 6210 <malloc+0x127c>
    2af4:	3ec020ef          	jal	4ee0 <printf>
      exit(1);
    2af8:	4505                	li	a0,1
    ...
    2b04:	79850513          	addi	a0,a0,1944 # 6298 <malloc+0x1304>
    2b08:	3d8020ef          	jal	4ee0 <printf>
      exit(1);
    2b0c:	4505                	li	a0,1
    ...
    2b18:	74450513          	addi	a0,a0,1860 # 6258 <malloc+0x12c4>
    2b1c:	3c4020ef          	jal	4ee0 <printf>
      exit(1);
    2b20:	4505                	li	a0,1
...
0000000000002b36 <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b92:	68250513          	addi	a0,a0,1666 # 6210 <malloc+0x127c>
    2b96:	34a020ef          	jal	4ee0 <printf>
    exit(1);
    2b9a:	4505                	li	a0,1
    ...
    2ba6:	71650513          	addi	a0,a0,1814 # 62b8 <malloc+0x1324>
    2baa:	336020ef          	jal	4ee0 <printf>
    exit(1);
    2bae:	4505                	li	a0,1
    ...
    2bba:	72250513          	addi	a0,a0,1826 # 62d8 <malloc+0x1344>
    2bbe:	322020ef          	jal	4ee0 <printf>
    exit(1);
    2bc2:	4505                	li	a0,1
    ...
    2bce:	72650513          	addi	a0,a0,1830 # 62f0 <malloc+0x135c>
    2bd2:	30e020ef          	jal	4ee0 <printf>
    exit(1);
    2bd6:	4505                	li	a0,1
...
0000000000002bdc <subdir>:
{
  ...
  unlink("ff");
    ...
    2bee:	84e50513          	addi	a0,a0,-1970 # 6438 <malloc+0x14a4>
    2bf2:	6df010ef          	jal	4ad0 <unlink>
  if(mkdir("dd") != 0){
    2bf6:	00003517          	auipc	a0,0x3
    2bfa:	71250513          	addi	a0,a0,1810 # 6308 <malloc+0x1374>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2c0e:	71e50513          	addi	a0,a0,1822 # 6328 <malloc+0x1394>
  ...
  write(fd, "ff", 2);
    ...
    2c22:	81a58593          	addi	a1,a1,-2022 # 6438 <malloc+0x14a4>
  ...
  if(unlink("dd") >= 0){
    ...
    2c34:	6d850513          	addi	a0,a0,1752 # 6308 <malloc+0x1374>
    2c38:	699010ef          	jal	4ad0 <unlink>
    2c3c:	2c055963          	bgez	a0,2f0e <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c40:	00003517          	auipc	a0,0x3
    2c44:	74050513          	addi	a0,a0,1856 # 6380 <malloc+0x13ec>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c58:	75450513          	addi	a0,a0,1876 # 63a8 <malloc+0x1414>
  ...
  write(fd, "FF", 2);
    ...
    2c6c:	77058593          	addi	a1,a1,1904 # 63d8 <malloc+0x1444>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c80:	76450513          	addi	a0,a0,1892 # 63e0 <malloc+0x144c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d66:	64650513          	addi	a0,a0,1606 # 63a8 <malloc+0x1414>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d7a:	84a50513          	addi	a0,a0,-1974 # 65c0 <malloc+0x162c>
  ...
  if(unlink("dd") < 0){
    ...
    2eec:	42850513          	addi	a0,a0,1064 # 6310 <malloc+0x137c>
    2ef0:	7f1010ef          	jal	4ee0 <printf>
    exit(1);
    2ef4:	4505                	li	a0,1
    ...
    2f00:	43450513          	addi	a0,a0,1076 # 6330 <malloc+0x139c>
    2f04:	7dd010ef          	jal	4ee0 <printf>
    exit(1);
    2f08:	4505                	li	a0,1
    ...
    2f14:	44050513          	addi	a0,a0,1088 # 6350 <malloc+0x13bc>
    2f18:	7c9010ef          	jal	4ee0 <printf>
    exit(1);
    2f1c:	4505                	li	a0,1
    ...
    2f28:	46450513          	addi	a0,a0,1124 # 6388 <malloc+0x13f4>
    2f2c:	7b5010ef          	jal	4ee0 <printf>
    exit(1);
    2f30:	4505                	li	a0,1
    ...
    2f3c:	48050513          	addi	a0,a0,1152 # 63b8 <malloc+0x1424>
    2f40:	7a1010ef          	jal	4ee0 <printf>
    exit(1);
    2f44:	4505                	li	a0,1
    ...
    2f50:	4a450513          	addi	a0,a0,1188 # 63f0 <malloc+0x145c>
    2f54:	78d010ef          	jal	4ee0 <printf>
    exit(1);
    2f58:	4505                	li	a0,1
    ...
    2f64:	4b050513          	addi	a0,a0,1200 # 6410 <malloc+0x147c>
    2f68:	779010ef          	jal	4ee0 <printf>
    exit(1);
    2f6c:	4505                	li	a0,1
    ...
    2f78:	4cc50513          	addi	a0,a0,1228 # 6440 <malloc+0x14ac>
    2f7c:	765010ef          	jal	4ee0 <printf>
    exit(1);
    2f80:	4505                	li	a0,1
    ...
    2f8c:	4e050513          	addi	a0,a0,1248 # 6468 <malloc+0x14d4>
    2f90:	751010ef          	jal	4ee0 <printf>
    exit(1);
    2f94:	4505                	li	a0,1
    ...
    2fa0:	4ec50513          	addi	a0,a0,1260 # 6488 <malloc+0x14f4>
    2fa4:	73d010ef          	jal	4ee0 <printf>
    exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2fb4:	50050513          	addi	a0,a0,1280 # 64b0 <malloc+0x151c>
    2fb8:	729010ef          	jal	4ee0 <printf>
    exit(1);
    2fbc:	4505                	li	a0,1
    ...
    2fc8:	51450513          	addi	a0,a0,1300 # 64d8 <malloc+0x1544>
    2fcc:	715010ef          	jal	4ee0 <printf>
    exit(1);
    2fd0:	4505                	li	a0,1
    ...
    2fdc:	53050513          	addi	a0,a0,1328 # 6508 <malloc+0x1574>
    2fe0:	701010ef          	jal	4ee0 <printf>
    exit(1);
    2fe4:	4505                	li	a0,1
    ...
    2ff0:	54c50513          	addi	a0,a0,1356 # 6538 <malloc+0x15a4>
    2ff4:	6ed010ef          	jal	4ee0 <printf>
    exit(1);
    2ff8:	4505                	li	a0,1
    ...
    3004:	55050513          	addi	a0,a0,1360 # 6550 <malloc+0x15bc>
    3008:	6d9010ef          	jal	4ee0 <printf>
    exit(1);
    300c:	4505                	li	a0,1
    ...
    3018:	55c50513          	addi	a0,a0,1372 # 6570 <malloc+0x15dc>
    301c:	6c5010ef          	jal	4ee0 <printf>
    exit(1);
    3020:	4505                	li	a0,1
    ...
    302c:	56850513          	addi	a0,a0,1384 # 6590 <malloc+0x15fc>
    3030:	6b1010ef          	jal	4ee0 <printf>
    exit(1);
    3034:	4505                	li	a0,1
    ...
    3040:	59450513          	addi	a0,a0,1428 # 65d0 <malloc+0x163c>
    3044:	69d010ef          	jal	4ee0 <printf>
    exit(1);
    3048:	4505                	li	a0,1
    ...
    3054:	5b050513          	addi	a0,a0,1456 # 6600 <malloc+0x166c>
    3058:	689010ef          	jal	4ee0 <printf>
    exit(1);
    305c:	4505                	li	a0,1
    ...
    3068:	5bc50513          	addi	a0,a0,1468 # 6620 <malloc+0x168c>
    306c:	675010ef          	jal	4ee0 <printf>
    exit(1);
    3070:	4505                	li	a0,1
    ...
    307c:	5c850513          	addi	a0,a0,1480 # 6640 <malloc+0x16ac>
    3080:	661010ef          	jal	4ee0 <printf>
    exit(1);
    3084:	4505                	li	a0,1
    ...
    3090:	5d450513          	addi	a0,a0,1492 # 6660 <malloc+0x16cc>
    3094:	64d010ef          	jal	4ee0 <printf>
    exit(1);
    3098:	4505                	li	a0,1
    ...
    30a4:	5f050513          	addi	a0,a0,1520 # 6690 <malloc+0x16fc>
    30a8:	639010ef          	jal	4ee0 <printf>
    exit(1);
    30ac:	4505                	li	a0,1
    ...
    30b8:	60450513          	addi	a0,a0,1540 # 66b8 <malloc+0x1724>
    30bc:	625010ef          	jal	4ee0 <printf>
    exit(1);
    30c0:	4505                	li	a0,1
    ...
    30cc:	61850513          	addi	a0,a0,1560 # 66e0 <malloc+0x174c>
    30d0:	611010ef          	jal	4ee0 <printf>
    exit(1);
    30d4:	4505                	li	a0,1
    ...
    30e0:	62c50513          	addi	a0,a0,1580 # 6708 <malloc+0x1774>
    30e4:	5fd010ef          	jal	4ee0 <printf>
    exit(1);
    30e8:	4505                	li	a0,1
    ...
    30f4:	63850513          	addi	a0,a0,1592 # 6728 <malloc+0x1794>
    30f8:	5e9010ef          	jal	4ee0 <printf>
    exit(1);
    30fc:	4505                	li	a0,1
    ...
    3108:	64450513          	addi	a0,a0,1604 # 6748 <malloc+0x17b4>
    310c:	5d5010ef          	jal	4ee0 <printf>
    exit(1);
    3110:	4505                	li	a0,1
    ...
    311c:	65850513          	addi	a0,a0,1624 # 6770 <malloc+0x17dc>
    3120:	5c1010ef          	jal	4ee0 <printf>
    exit(1);
    3124:	4505                	li	a0,1
    ...
    3130:	66450513          	addi	a0,a0,1636 # 6790 <malloc+0x17fc>
    3134:	5ad010ef          	jal	4ee0 <printf>
    exit(1);
    3138:	4505                	li	a0,1
    ...
    3144:	67050513          	addi	a0,a0,1648 # 67b0 <malloc+0x181c>
    3148:	599010ef          	jal	4ee0 <printf>
    exit(1);
    314c:	4505                	li	a0,1
    ...
    3158:	68450513          	addi	a0,a0,1668 # 67d8 <malloc+0x1844>
    315c:	585010ef          	jal	4ee0 <printf>
    exit(1);
    3160:	4505                	li	a0,1
    ...
    316c:	30050513          	addi	a0,a0,768 # 6468 <malloc+0x14d4>
    3170:	571010ef          	jal	4ee0 <printf>
    exit(1);
    3174:	4505                	li	a0,1
    ...
    3180:	67c50513          	addi	a0,a0,1660 # 67f8 <malloc+0x1864>
    3184:	55d010ef          	jal	4ee0 <printf>
    exit(1);
    3188:	4505                	li	a0,1
    ...
    3194:	68850513          	addi	a0,a0,1672 # 6818 <malloc+0x1884>
    3198:	549010ef          	jal	4ee0 <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31a8:	6a450513          	addi	a0,a0,1700 # 6848 <malloc+0x18b4>
    31ac:	535010ef          	jal	4ee0 <printf>
    exit(1);
    31b0:	4505                	li	a0,1
    ...
    31bc:	6b050513          	addi	a0,a0,1712 # 6868 <malloc+0x18d4>
    31c0:	521010ef          	jal	4ee0 <printf>
    exit(1);
    31c4:	4505                	li	a0,1
...
00000000000031ca <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    3256:	63650513          	addi	a0,a0,1590 # 6888 <malloc+0x18f4>
    325a:	487010ef          	jal	4ee0 <printf>
    exit(1);
    325e:	4505                	li	a0,1
    ...
    326a:	63a50513          	addi	a0,a0,1594 # 68a0 <malloc+0x190c>
    326e:	473010ef          	jal	4ee0 <printf>
    exit(1);
    3272:	4505                	li	a0,1
    ...
    327e:	63e50513          	addi	a0,a0,1598 # 68b8 <malloc+0x1924>
    3282:	45f010ef          	jal	4ee0 <printf>
    exit(1);
    3286:	4505                	li	a0,1
    ...
    3292:	64250513          	addi	a0,a0,1602 # 68d0 <malloc+0x193c>
    3296:	44b010ef          	jal	4ee0 <printf>
    exit(1);
    329a:	4505                	li	a0,1
    ...
    32a6:	fde50513          	addi	a0,a0,-34 # 6280 <malloc+0x12ec>
    32aa:	437010ef          	jal	4ee0 <printf>
    exit(1);
    32ae:	4505                	li	a0,1
    ...
    32ba:	63a50513          	addi	a0,a0,1594 # 68f0 <malloc+0x195c>
    32be:	423010ef          	jal	4ee0 <printf>
    exit(1);
    32c2:	4505                	li	a0,1
    ...
    32ce:	64e50513          	addi	a0,a0,1614 # 6918 <malloc+0x1984>
    32d2:	40f010ef          	jal	4ee0 <printf>
    exit(1);
    32d6:	4505                	li	a0,1
    ...
    32e2:	65a50513          	addi	a0,a0,1626 # 6938 <malloc+0x19a4>
    32e6:	3fb010ef          	jal	4ee0 <printf>
    exit(1);
    32ea:	4505                	li	a0,1
...
00000000000032f0 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3306:	65650513          	addi	a0,a0,1622 # 6958 <malloc+0x19c4>
  ...
  if(chdir("dirfile") == 0){
    ...
    331a:	64250513          	addi	a0,a0,1602 # 6958 <malloc+0x19c4>
    331e:	7d2010ef          	jal	4af0 <chdir>
    3322:	c569                	beqz	a0,33ec <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3324:	4581                	li	a1,0
    3326:	00003517          	auipc	a0,0x3
    332a:	67a50513          	addi	a0,a0,1658 # 69a0 <malloc+0x1a0c>
  ...
  fd = open(".", 0);
    ...
    33aa:	40a50513          	addi	a0,a0,1034 # 57b0 <malloc+0x81c>
    33ae:	712010ef          	jal	4ac0 <open>
    33b2:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    33b4:	4605                	li	a2,1
    33b6:	00002597          	auipc	a1,0x2
    33ba:	d8258593          	addi	a1,a1,-638 # 5138 <malloc+0x1a4>
  ...
  close(fd);
    ...
    33de:	58650513          	addi	a0,a0,1414 # 6960 <malloc+0x19cc>
    33e2:	2ff010ef          	jal	4ee0 <printf>
    exit(1);
    33e6:	4505                	li	a0,1
    ...
    33f2:	59250513          	addi	a0,a0,1426 # 6980 <malloc+0x19ec>
    33f6:	2eb010ef          	jal	4ee0 <printf>
    exit(1);
    33fa:	4505                	li	a0,1
    ...
    3406:	5ae50513          	addi	a0,a0,1454 # 69b0 <malloc+0x1a1c>
    340a:	2d7010ef          	jal	4ee0 <printf>
    exit(1);
    340e:	4505                	li	a0,1
    ...
    341a:	59a50513          	addi	a0,a0,1434 # 69b0 <malloc+0x1a1c>
    341e:	2c3010ef          	jal	4ee0 <printf>
    exit(1);
    3422:	4505                	li	a0,1
    ...
    342e:	5ae50513          	addi	a0,a0,1454 # 69d8 <malloc+0x1a44>
    3432:	2af010ef          	jal	4ee0 <printf>
    exit(1);
    3436:	4505                	li	a0,1
    ...
    3442:	5c250513          	addi	a0,a0,1474 # 6a00 <malloc+0x1a6c>
    3446:	29b010ef          	jal	4ee0 <printf>
    exit(1);
    344a:	4505                	li	a0,1
    ...
    3456:	5d650513          	addi	a0,a0,1494 # 6a28 <malloc+0x1a94>
    345a:	287010ef          	jal	4ee0 <printf>
    exit(1);
    345e:	4505                	li	a0,1
    ...
    346a:	5ea50513          	addi	a0,a0,1514 # 6a50 <malloc+0x1abc>
    346e:	273010ef          	jal	4ee0 <printf>
    exit(1);
    3472:	4505                	li	a0,1
    ...
    347e:	5f650513          	addi	a0,a0,1526 # 6a70 <malloc+0x1adc>
    3482:	25f010ef          	jal	4ee0 <printf>
    exit(1);
    3486:	4505                	li	a0,1
    ...
    3492:	60a50513          	addi	a0,a0,1546 # 6a98 <malloc+0x1b04>
    3496:	24b010ef          	jal	4ee0 <printf>
    exit(1);
    349a:	4505                	li	a0,1
...
00000000000034a0 <iref>:
{
    ...
    34be:	5f6a0a13          	addi	s4,s4,1526 # 6ab0 <malloc+0x1b1c>
    mkdir("");
    34c2:	00003497          	auipc	s1,0x3
    34c6:	0f648493          	addi	s1,s1,246 # 65b8 <malloc+0x1624>
    link("README", "");
    34ca:	00002a97          	auipc	s5,0x2
    34ce:	dd6a8a93          	addi	s5,s5,-554 # 52a0 <malloc+0x30c>
    fd = open("xx", O_CREATE);
    34d2:	00003997          	auipc	s3,0x3
    34d6:	4d698993          	addi	s3,s3,1238 # 69a8 <malloc+0x1a14>
    34da:	a835                	j	3516 <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34dc:	85da                	mv	a1,s6
    34de:	00003517          	auipc	a0,0x3
    34e2:	5da50513          	addi	a0,a0,1498 # 6ab8 <malloc+0x1b24>
    34e6:	1fb010ef          	jal	4ee0 <printf>
      exit(1);
    34ea:	4505                	li	a0,1
    ...
    34f6:	5de50513          	addi	a0,a0,1502 # 6ad0 <malloc+0x1b3c>
    34fa:	1e7010ef          	jal	4ee0 <printf>
      exit(1);
    34fe:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    355e:	d7698993          	addi	s3,s3,-650 # 62d0 <malloc+0x133c>
    unlink("irefd");
    3562:	00003917          	auipc	s2,0x3
    3566:	54e90913          	addi	s2,s2,1358 # 6ab0 <malloc+0x1b1c>
    chdir("..");
    356a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    357e:	cfe50513          	addi	a0,a0,-770 # 6278 <malloc+0x12e4>
...
000000000000359a <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    35aa:	54250513          	addi	a0,a0,1346 # 6ae8 <malloc+0x1b54>
  ...
  if(pid == 0){
    ...
    35c6:	52650513          	addi	a0,a0,1318 # 6ae8 <malloc+0x1b54>
    ...
    35d8:	53450513          	addi	a0,a0,1332 # 6b08 <malloc+0x1b74>
    35dc:	105010ef          	jal	4ee0 <printf>
      exit(1);
    35e0:	4505                	li	a0,1
    ...
    35ec:	50850513          	addi	a0,a0,1288 # 6af0 <malloc+0x1b5c>
    35f0:	0f1010ef          	jal	4ee0 <printf>
    exit(1);
    35f4:	4505                	li	a0,1
    ...
    3600:	35c50513          	addi	a0,a0,860 # 5958 <malloc+0x9c4>
    3604:	0dd010ef          	jal	4ee0 <printf>
    exit(1);
    3608:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    361e:	4ce50513          	addi	a0,a0,1230 # 6ae8 <malloc+0x1b54>
    3622:	4ae010ef          	jal	4ad0 <unlink>
    3626:	c919                	beqz	a0,363c <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    3628:	85a6                	mv	a1,s1
    362a:	00002517          	auipc	a0,0x2
    362e:	51e50513          	addi	a0,a0,1310 # 5b48 <malloc+0xbb4>
    3632:	0af010ef          	jal	4ee0 <printf>
    exit(1);
    3636:	4505                	li	a0,1
...
000000000000364c <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    365c:	4d850513          	addi	a0,a0,1240 # 6b30 <malloc+0x1b9c>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    367c:	4b850513          	addi	a0,a0,1208 # 6b30 <malloc+0x1b9c>
  ...
  sleep(10); // one second
    ...
    36a4:	47850513          	addi	a0,a0,1144 # 5b18 <malloc+0xb84>
    36a8:	039010ef          	jal	4ee0 <printf>
    exit(1);
    36ac:	4505                	li	a0,1
    36ae:	3d2010ef          	jal	4a80 <exit>
      int fd = open("stopforking", 0);
    36b2:	00003497          	auipc	s1,0x3
    36b6:	47e48493          	addi	s1,s1,1150 # 6b30 <malloc+0x1b9c>
    36ba:	4581                	li	a1,0
    36bc:	8526                	mv	a0,s1
    ...
    36d6:	45e50513          	addi	a0,a0,1118 # 6b30 <malloc+0x1b9c>
...
00000000000036ea <killstatus>:
{
  ...
  exit(0);
    ...
    373c:	22050513          	addi	a0,a0,544 # 5958 <malloc+0x9c4>
    3740:	7a0010ef          	jal	4ee0 <printf>
      exit(1);
    3744:	4505                	li	a0,1
    ...
    3756:	3ee50513          	addi	a0,a0,1006 # 6b40 <malloc+0x1bac>
    375a:	786010ef          	jal	4ee0 <printf>
       exit(1);
    375e:	4505                	li	a0,1
...
0000000000003764 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    378a:	39250513          	addi	a0,a0,914 # 5b18 <malloc+0xb84>
    378e:	752010ef          	jal	4ee0 <printf>
    exit(1);
    3792:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    37ac:	1b050513          	addi	a0,a0,432 # 5958 <malloc+0x9c4>
    37b0:	730010ef          	jal	4ee0 <printf>
    exit(1);
    37b4:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    37dc:	96058593          	addi	a1,a1,-1696 # 5138 <malloc+0x1a4>
    ...
    37fe:	15e50513          	addi	a0,a0,350 # 5958 <malloc+0x9c4>
    3802:	6de010ef          	jal	4ee0 <printf>
     exit(1);
    3806:	4505                	li	a0,1
    ...
    3812:	35250513          	addi	a0,a0,850 # 6b60 <malloc+0x1bcc>
    3816:	6ca010ef          	jal	4ee0 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3842:	33a50513          	addi	a0,a0,826 # 6b78 <malloc+0x1be4>
    3846:	69a010ef          	jal	4ee0 <printf>
}
  ...
  printf("kill... ");
    ...
    3866:	32e50513          	addi	a0,a0,814 # 6b90 <malloc+0x1bfc>
    386a:	676010ef          	jal	4ee0 <printf>
  kill(pid1);
    386e:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    3884:	32050513          	addi	a0,a0,800 # 6ba0 <malloc+0x1c0c>
    3888:	658010ef          	jal	4ee0 <printf>
  wait(0);
    388c:	4501                	li	a0,0
...
00000000000038a0 <reparent>:
{
  ...
  exit(0);
    ...
    38e4:	07850513          	addi	a0,a0,120 # 5958 <malloc+0x9c4>
    38e8:	5f8010ef          	jal	4ee0 <printf>
      exit(1);
    38ec:	4505                	li	a0,1
    ...
    38f8:	1ec50513          	addi	a0,a0,492 # 5ae0 <malloc+0xb4c>
    38fc:	5e4010ef          	jal	4ee0 <printf>
        exit(1);
    3900:	4505                	li	a0,1
...
0000000000003920 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3952:	11250513          	addi	a0,a0,274 # 5a60 <malloc+0xacc>
    3956:	58a010ef          	jal	4ee0 <printf>
    exit(1);
    395a:	4505                	li	a0,1
    ...
    3976:	7c658593          	addi	a1,a1,1990 # 5138 <malloc+0x1a4>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3a16:	19e50513          	addi	a0,a0,414 # 6bb0 <malloc+0x1c1c>
    3a1a:	4c6010ef          	jal	4ee0 <printf>
    exit(1);
    3a1e:	4505                	li	a0,1
    ...
    3a2a:	f3250513          	addi	a0,a0,-206 # 5958 <malloc+0x9c4>
    3a2e:	4b2010ef          	jal	4ee0 <printf>
    exit(1);
    3a32:	4505                	li	a0,1
    ...
    3a66:	16e50513          	addi	a0,a0,366 # 6bd0 <malloc+0x1c3c>
    3a6a:	476010ef          	jal	4ee0 <printf>
    exit(1);
    3a6e:	4505                	li	a0,1
...
0000000000003a7a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3abe:	6084                	ld	s1,0(s1)
      free(m1);
    3ac0:	452010ef          	jal	4f12 <free>
    while(m1){
    3ac4:	fce5                	bnez	s1,3abc <mem+0x42>
    m1 = malloc(1024*20);
    3ac6:	6515                	lui	a0,0x5
    3ac8:	4cc010ef          	jal	4f94 <malloc>
    if(m1 == 0){
    3acc:	c511                	beqz	a0,3ad8 <mem+0x5e>
    free(m1);
    3ace:	444010ef          	jal	4f12 <free>
    exit(0);
    3ad2:	4501                	li	a0,0
    ...
    3ade:	12650513          	addi	a0,a0,294 # 6c00 <malloc+0x1c6c>
    3ae2:	3fe010ef          	jal	4ee0 <printf>
      exit(1);
    3ae6:	4505                	li	a0,1
...
0000000000003af2 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b02:	12250513          	addi	a0,a0,290 # 6c20 <malloc+0x1c8c>
    3b06:	7cb000ef          	jal	4ad0 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b0a:	20200593          	li	a1,514
    3b0e:	00003517          	auipc	a0,0x3
    3b12:	11250513          	addi	a0,a0,274 # 6c20 <malloc+0x1c8c>
  ...
  if(pid == 0) {
    ...
    3b7c:	0b850513          	addi	a0,a0,184 # 6c30 <malloc+0x1c9c>
    3b80:	360010ef          	jal	4ee0 <printf>
    exit(1);
    3b84:	4505                	li	a0,1
    ...
    3b90:	0cc50513          	addi	a0,a0,204 # 6c58 <malloc+0x1cc4>
    3b94:	34c010ef          	jal	4ee0 <printf>
      exit(1);
    3b98:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3bc0:	06450513          	addi	a0,a0,100 # 6c20 <malloc+0x1c8c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3bf8:	08450513          	addi	a0,a0,132 # 6c78 <malloc+0x1ce4>
    3bfc:	2e4010ef          	jal	4ee0 <printf>
    exit(1);
    3c00:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3c28:	ffc50513          	addi	a0,a0,-4 # 6c20 <malloc+0x1c8c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c4a:	05a50513          	addi	a0,a0,90 # 6ca0 <malloc+0x1d0c>
    3c4e:	292010ef          	jal	4ee0 <printf>
    exit(1);
    3c52:	4505                	li	a0,1
...
0000000000003c5e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c82:	03a78793          	addi	a5,a5,58 # 6cb8 <malloc+0x1d24>
    3c86:	f6f43823          	sd	a5,-144(s0)
    3c8a:	00003797          	auipc	a5,0x3
    3c8e:	03678793          	addi	a5,a5,54 # 6cc0 <malloc+0x1d2c>
    3c92:	f6f43c23          	sd	a5,-136(s0)
    3c96:	00003797          	auipc	a5,0x3
    3c9a:	03278793          	addi	a5,a5,50 # 6cc8 <malloc+0x1d34>
    3c9e:	f8f43023          	sd	a5,-128(s0)
    3ca2:	00003797          	auipc	a5,0x3
    3ca6:	02e78793          	addi	a5,a5,46 # 6cd0 <malloc+0x1d3c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d08:	c5450513          	addi	a0,a0,-940 # 5958 <malloc+0x9c4>
    3d0c:	1d4010ef          	jal	4ee0 <printf>
      exit(1);
    3d10:	4505                	li	a0,1
    ...
    3d6a:	c8a50513          	addi	a0,a0,-886 # 59f0 <malloc+0xa5c>
    3d6e:	172010ef          	jal	4ee0 <printf>
        exit(1);
    3d72:	4505                	li	a0,1
    3d74:	50d000ef          	jal	4a80 <exit>
          printf("write failed %d\n", n);
    3d78:	00003517          	auipc	a0,0x3
    3d7c:	f6050513          	addi	a0,a0,-160 # 6cd8 <malloc+0x1d44>
    3d80:	160010ef          	jal	4ee0 <printf>
          exit(1);
    3d84:	4505                	li	a0,1
    ...
    3d96:	f5e50513          	addi	a0,a0,-162 # 6cf0 <malloc+0x1d5c>
    3d9a:	146010ef          	jal	4ee0 <printf>
          exit(1);
    3d9e:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e06:	efe50513          	addi	a0,a0,-258 # 6d00 <malloc+0x1d6c>
    3e0a:	0d6010ef          	jal	4ee0 <printf>
      exit(1);
    3e0e:	4505                	li	a0,1
...
0000000000003e32 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e60:	ebcb8b93          	addi	s7,s7,-324 # 6d18 <malloc+0x1d84>
  for(i = 0; i < N; i++){
    ...
    3e9a:	e8a50513          	addi	a0,a0,-374 # 6d20 <malloc+0x1d8c>
    3e9e:	042010ef          	jal	4ee0 <printf>
        exit(1);
    3ea2:	4505                	li	a0,1
    ...
    3eb0:	e6c50513          	addi	a0,a0,-404 # 6d18 <malloc+0x1d84>
  ...
  fd = open(".", 0);
    ...
    3ed8:	8dc50513          	addi	a0,a0,-1828 # 57b0 <malloc+0x81c>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f48:	dfc50513          	addi	a0,a0,-516 # 6d40 <malloc+0x1dac>
    3f4c:	795000ef          	jal	4ee0 <printf>
        exit(1);
    3f50:	4505                	li	a0,1
    ...
    3f60:	e0450513          	addi	a0,a0,-508 # 6d60 <malloc+0x1dcc>
    3f64:	77d000ef          	jal	4ee0 <printf>
        exit(1);
    3f68:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f8c:	e0050513          	addi	a0,a0,-512 # 6d88 <malloc+0x1df4>
    3f90:	751000ef          	jal	4ee0 <printf>
    exit(1);
    3f94:	4505                	li	a0,1
    ...
    3fa0:	9bc50513          	addi	a0,a0,-1604 # 5958 <malloc+0x9c4>
    3fa4:	73d000ef          	jal	4ee0 <printf>
      exit(1);
    3fa8:	4505                	li	a0,1
...
00000000000040d6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40ee:	cd650513          	addi	a0,a0,-810 # 6dc0 <malloc+0x1e2c>
    40f2:	1df000ef          	jal	4ad0 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    40f6:	20200593          	li	a1,514
    40fa:	00003517          	auipc	a0,0x3
    40fe:	cc650513          	addi	a0,a0,-826 # 6dc0 <malloc+0x1e2c>
  ...
  fd = open("bigfile.dat", 0);
    ...
    414a:	c7a50513          	addi	a0,a0,-902 # 6dc0 <malloc+0x1e2c>
  ...
  for(i = 0; ; i++){
    ...
    41a6:	c2e50513          	addi	a0,a0,-978 # 6dd0 <malloc+0x1e3c>
    41aa:	537000ef          	jal	4ee0 <printf>
    exit(1);
    41ae:	4505                	li	a0,1
    ...
    41ba:	c3a50513          	addi	a0,a0,-966 # 6df0 <malloc+0x1e5c>
    41be:	523000ef          	jal	4ee0 <printf>
      exit(1);
    41c2:	4505                	li	a0,1
    ...
    41ce:	c4650513          	addi	a0,a0,-954 # 6e10 <malloc+0x1e7c>
    41d2:	50f000ef          	jal	4ee0 <printf>
    exit(1);
    41d6:	4505                	li	a0,1
    ...
    41e2:	c5250513          	addi	a0,a0,-942 # 6e30 <malloc+0x1e9c>
    41e6:	4fb000ef          	jal	4ee0 <printf>
      exit(1);
    41ea:	4505                	li	a0,1
    ...
    41f6:	c5e50513          	addi	a0,a0,-930 # 6e50 <malloc+0x1ebc>
    41fa:	4e7000ef          	jal	4ee0 <printf>
      exit(1);
    41fe:	4505                	li	a0,1
    ...
    420a:	c6250513          	addi	a0,a0,-926 # 6e68 <malloc+0x1ed4>
    420e:	4d3000ef          	jal	4ee0 <printf>
      exit(1);
    4212:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    422c:	b9850513          	addi	a0,a0,-1128 # 6dc0 <malloc+0x1e2c>
    ...
    424c:	c4050513          	addi	a0,a0,-960 # 6e88 <malloc+0x1ef4>
    4250:	491000ef          	jal	4ee0 <printf>
    exit(1);
    4254:	4505                	li	a0,1
...
000000000000425a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    426a:	c4250513          	addi	a0,a0,-958 # 6ea8 <malloc+0x1f14>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4290:	c1c50513          	addi	a0,a0,-996 # 6ea8 <malloc+0x1f14>
  ...
  close(fd);
    ...
    42ea:	de250513          	addi	a0,a0,-542 # 50c8 <malloc+0x134>
    42ee:	7ca000ef          	jal	4ab8 <exec>
    fd = open("bigarg-ok", O_CREATE);
    42f2:	20000593          	li	a1,512
    42f6:	00003517          	auipc	a0,0x3
    42fa:	bb250513          	addi	a0,a0,-1102 # 6ea8 <malloc+0x1f14>
    ...
    4312:	baa50513          	addi	a0,a0,-1110 # 6eb8 <malloc+0x1f24>
    4316:	3cb000ef          	jal	4ee0 <printf>
    exit(1);
    431a:	4505                	li	a0,1
    ...
    432a:	bb250513          	addi	a0,a0,-1102 # 6ed8 <malloc+0x1f44>
    432e:	3b3000ef          	jal	4ee0 <printf>
    exit(1);
    4332:	4505                	li	a0,1
...
0000000000004338 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4358:	ba450513          	addi	a0,a0,-1116 # 6ef8 <malloc+0x1f64>
    435c:	385000ef          	jal	4ee0 <printf>
  for(nfiles = 0; ; nfiles++){
    4360:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4374:	b98c8c93          	addi	s9,s9,-1128 # 6f08 <malloc+0x1f74>
    name[0] = 'f';
    ...
    43dc:	b4050513          	addi	a0,a0,-1216 # 6f18 <malloc+0x1f84>
    43e0:	301000ef          	jal	4ee0 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    444a:	af250513          	addi	a0,a0,-1294 # 6f38 <malloc+0x1fa4>
    444e:	293000ef          	jal	4ee0 <printf>
}
    ...
    4498:	a9450513          	addi	a0,a0,-1388 # 6f28 <malloc+0x1f94>
    449c:	245000ef          	jal	4ee0 <printf>
    close(fd);
    44a0:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    44c2:	a9250513          	addi	a0,a0,-1390 # 6f50 <malloc+0x1fbc>
    44c6:	21b000ef          	jal	4ee0 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    44e6:	a9650513          	addi	a0,a0,-1386 # 6f78 <malloc+0x1fe4>
    44ea:	1f7000ef          	jal	4ee0 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4506:	a5e50513          	addi	a0,a0,-1442 # 6f60 <malloc+0x1fcc>
    450a:	1d7000ef          	jal	4ee0 <printf>
    exit(1);
    450e:	4505                	li	a0,1
    ...
    4522:	a6250513          	addi	a0,a0,-1438 # 6f80 <malloc+0x1fec>
    4526:	1bb000ef          	jal	4ee0 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    457a:	a1250513          	addi	a0,a0,-1518 # 6f88 <malloc+0x1ff4>
    457e:	163000ef          	jal	4ee0 <printf>
          return 1;
    4582:	4505                	li	a0,1
...
countfree()
{
  ...
  if(pid == 0){
    ...
    45da:	b6298993          	addi	s3,s3,-1182 # 5138 <malloc+0x1a4>
      uint64 a = (uint64) sbrk(4096);
    ...
    4604:	9e050513          	addi	a0,a0,-1568 # 6fe0 <malloc+0x204c>
    4608:	0d9000ef          	jal	4ee0 <printf>
        exit(1);
    460c:	4505                	li	a0,1
    ...
    461c:	98850513          	addi	a0,a0,-1656 # 6fa0 <malloc+0x200c>
    4620:	0c1000ef          	jal	4ee0 <printf>
    exit(1);
    4624:	4505                	li	a0,1
    ...
    4634:	99050513          	addi	a0,a0,-1648 # 6fc0 <malloc+0x202c>
    4638:	0a9000ef          	jal	4ee0 <printf>
    exit(1);
    463c:	4505                	li	a0,1
  ...
  while(1){
    ...
    4674:	99050513          	addi	a0,a0,-1648 # 7000 <malloc+0x206c>
    4678:	069000ef          	jal	4ee0 <printf>
      exit(1);
    467c:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    46c2:	962b8b93          	addi	s7,s7,-1694 # 7020 <malloc+0x208c>
    int free0 = countfree();
    int free1 = 0;
    ...
    46dc:	960d0d13          	addi	s10,s10,-1696 # 7038 <malloc+0x20a4>
          return 1;
        }
      }
    }
    ...
    46e4:	978c8c93          	addi	s9,s9,-1672 # 7058 <malloc+0x20c4>
    46e8:	a819                	j	46fe <drivetests+0x62>
        printf("usertests slow tests starting\n");
    46ea:	856a                	mv	a0,s10
    46ec:	7f4000ef          	jal	4ee0 <printf>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    47a0:	8ec58593          	addi	a1,a1,-1812 # 7088 <malloc+0x20f4>
    47a4:	854a                	mv	a0,s2
    ...
    47b2:	8e258593          	addi	a1,a1,-1822 # 7090 <malloc+0x20fc>
    47b6:	854a                	mv	a0,s2
    47b8:	08c000ef          	jal	4844 <strcmp>
    47bc:	cd15                	beqz	a0,47f8 <main+0x8e>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    47be:	00003597          	auipc	a1,0x3
    47c2:	8da58593          	addi	a1,a1,-1830 # 7098 <malloc+0x2104>
    47c6:	854a                	mv	a0,s2
  ...
  int continuous = 0;
    ...
    47e4:	8c050513          	addi	a0,a0,-1856 # 70a0 <malloc+0x210c>
    47e8:	6f8000ef          	jal	4ee0 <printf>
    exit(1);
    47ec:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4808:	8cc50513          	addi	a0,a0,-1844 # 70d0 <malloc+0x213c>
    480c:	6d4000ef          	jal	4ee0 <printf>
  exit(0);
    4810:	4501                	li	a0,0
...
putc(int fd, char c)
{
    4b68:	1101                	addi	sp,sp,-32
    4b6a:	ec06                	sd	ra,24(sp)
    4b6c:	e822                	sd	s0,16(sp)
    4b6e:	1000                	addi	s0,sp,32
    4b70:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4b74:	4605                	li	a2,1
    4b76:	fef40593          	addi	a1,s0,-17
    4b7a:	f27ff0ef          	jal	4aa0 <write>
}
    4b7e:	60e2                	ld	ra,24(sp)
    4b80:	6442                	ld	s0,16(sp)
    4b82:	6105                	addi	sp,sp,32
    4b84:	8082                	ret

0000000000004b86 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    4b86:	7139                	addi	sp,sp,-64
    4b88:	fc06                	sd	ra,56(sp)
    4b8a:	f822                	sd	s0,48(sp)
    4b8c:	f426                	sd	s1,40(sp)
    4b8e:	0080                	addi	s0,sp,64
    4b90:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4b92:	c299                	beqz	a3,4b98 <printint+0x12>
    4b94:	0805c963          	bltz	a1,4c26 <printint+0xa0>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    4b98:	2581                	sext.w	a1,a1
  neg = 0;
    4b9a:	4881                	li	a7,0
    4b9c:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    4ba2:	2601                	sext.w	a2,a2
    4ba4:	00003517          	auipc	a0,0x3
    4ba8:	8fc50513          	addi	a0,a0,-1796 # 74a0 <digits>
    4bac:	883a                	mv	a6,a4
    4bae:	2705                	addiw	a4,a4,1
    4bb0:	02c5f7bb          	remuw	a5,a1,a2
    4bb4:	1782                	slli	a5,a5,0x20
    4bb6:	9381                	srli	a5,a5,0x20
    4bb8:	97aa                	add	a5,a5,a0
    4bba:	0007c783          	lbu	a5,0(a5)
    4bbe:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    4bc2:	0005879b          	sext.w	a5,a1
    4bc6:	02c5d5bb          	divuw	a1,a1,a2
    4bca:	0685                	addi	a3,a3,1
    4bcc:	fec7f0e3          	bgeu	a5,a2,4bac <printint+0x26>
  if(neg)
    4bd0:	00088c63          	beqz	a7,4be8 <printint+0x62>
    buf[i++] = '-';
    4bd4:	fd070793          	addi	a5,a4,-48
    4bd8:	00878733          	add	a4,a5,s0
    4bdc:	02d00793          	li	a5,45
    4be0:	fef70823          	sb	a5,-16(a4)
    4be4:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    4be8:	02e05a63          	blez	a4,4c1c <printint+0x96>
    4bec:	f04a                	sd	s2,32(sp)
    4bee:	ec4e                	sd	s3,24(sp)
    4bf0:	fc040793          	addi	a5,s0,-64
    4bf4:	00e78933          	add	s2,a5,a4
    4bf8:	fff78993          	addi	s3,a5,-1
    4bfc:	99ba                	add	s3,s3,a4
    4bfe:	377d                	addiw	a4,a4,-1
    4c00:	1702                	slli	a4,a4,0x20
    4c02:	9301                	srli	a4,a4,0x20
    4c04:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    4c08:	fff94583          	lbu	a1,-1(s2)
    4c0c:	8526                	mv	a0,s1
    4c0e:	f5bff0ef          	jal	4b68 <putc>
  while(--i >= 0)
    4c12:	197d                	addi	s2,s2,-1
    4c14:	ff391ae3          	bne	s2,s3,4c08 <printint+0x82>
    4c18:	7902                	ld	s2,32(sp)
    4c1a:	69e2                	ld	s3,24(sp)
}
    4c1c:	70e2                	ld	ra,56(sp)
    4c1e:	7442                	ld	s0,48(sp)
    4c20:	74a2                	ld	s1,40(sp)
    4c22:	6121                	addi	sp,sp,64
    4c24:	8082                	ret
    x = -xx;
    4c26:	40b005bb          	negw	a1,a1
    neg = 1;
    4c2a:	4885                	li	a7,1
    x = -xx;
    4c2c:	bf85                	j	4b9c <printint+0x16>

0000000000004c2e <vprintf>:
}
...
{
    4c2e:	711d                	addi	sp,sp,-96
    4c30:	ec86                	sd	ra,88(sp)
    4c32:	e8a2                	sd	s0,80(sp)
    4c34:	e0ca                	sd	s2,64(sp)
    4c36:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4c38:	0005c903          	lbu	s2,0(a1)
    4c3c:	26090863          	beqz	s2,4eac <vprintf+0x27e>
    4c40:	e4a6                	sd	s1,72(sp)
    4c42:	fc4e                	sd	s3,56(sp)
    4c44:	f852                	sd	s4,48(sp)
    4c46:	f456                	sd	s5,40(sp)
    4c48:	f05a                	sd	s6,32(sp)
    4c4a:	ec5e                	sd	s7,24(sp)
    4c4c:	e862                	sd	s8,16(sp)
    4c4e:	e466                	sd	s9,8(sp)
    4c50:	8b2a                	mv	s6,a0
    4c52:	8a2e                	mv	s4,a1
    4c54:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4c5c:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4c60:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4c64:	06c00c93          	li	s9,108
    4c68:	a005                	j	4c88 <vprintf+0x5a>
        putc(fd, c0);
    4c6a:	85ca                	mv	a1,s2
    4c6c:	855a                	mv	a0,s6
    4c6e:	efbff0ef          	jal	4b68 <putc>
    4c72:	a019                	j	4c78 <vprintf+0x4a>
    } else if(state == '%'){
    4c74:	03598263          	beq	s3,s5,4c98 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    4c78:	2485                	addiw	s1,s1,1
    4c7a:	8726                	mv	a4,s1
    4c7c:	009a07b3          	add	a5,s4,s1
    4c80:	0007c903          	lbu	s2,0(a5)
    4c84:	20090c63          	beqz	s2,4e9c <vprintf+0x26e>
    c0 = fmt[i] & 0xff;
    4c88:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4c8c:	fe0994e3          	bnez	s3,4c74 <vprintf+0x46>
      if(c0 == '%'){
    4c90:	fd579de3          	bne	a5,s5,4c6a <vprintf+0x3c>
        state = '%';
    4c94:	89be                	mv	s3,a5
    4c96:	b7cd                	j	4c78 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4c98:	00ea06b3          	add	a3,s4,a4
    4c9c:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4ca0:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4ca2:	c681                	beqz	a3,4caa <vprintf+0x7c>
    4ca4:	9752                	add	a4,a4,s4
    4ca6:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4caa:	03878f63          	beq	a5,s8,4ce8 <vprintf+0xba>
      } else if(c0 == 'l' && c1 == 'd'){
    4cae:	05978963          	beq	a5,s9,4d00 <vprintf+0xd2>
    ...
    4cb2:	07500713          	li	a4,117
    4cb6:	0ee78363          	beq	a5,a4,4d9c <vprintf+0x16e>
    ...
    4cba:	07800713          	li	a4,120
    4cbe:	12e78563          	beq	a5,a4,4de8 <vprintf+0x1ba>
    ...
    4cc2:	07000713          	li	a4,112
    4cc6:	14e78a63          	beq	a5,a4,4e1a <vprintf+0x1ec>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 's'){
    4cca:	07300713          	li	a4,115
    4cce:	18e78a63          	beq	a5,a4,4e62 <vprintf+0x234>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4cd2:	02500713          	li	a4,37
    4cd6:	04e79563          	bne	a5,a4,4d20 <vprintf+0xf2>
        putc(fd, '%');
    4cda:	02500593          	li	a1,37
    4cde:	855a                	mv	a0,s6
    4ce0:	e89ff0ef          	jal	4b68 <putc>
      ...
      state = 0;
    4ce4:	4981                	li	s3,0
    4ce6:	bf49                	j	4c78 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    4ce8:	008b8913          	addi	s2,s7,8
    4cec:	4685                	li	a3,1
    4cee:	4629                	li	a2,10
    4cf0:	000ba583          	lw	a1,0(s7)
    4cf4:	855a                	mv	a0,s6
    4cf6:	e91ff0ef          	jal	4b86 <printint>
    4cfa:	8bca                	mv	s7,s2
      state = 0;
    4cfc:	4981                	li	s3,0
    4cfe:	bfad                	j	4c78 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4d00:	06400793          	li	a5,100
    4d04:	02f68963          	beq	a3,a5,4d36 <vprintf+0x108>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4d08:	06c00793          	li	a5,108
    4d0c:	04f68263          	beq	a3,a5,4d50 <vprintf+0x122>
      } else if(c0 == 'l' && c1 == 'u'){
    4d10:	07500793          	li	a5,117
    4d14:	0af68063          	beq	a3,a5,4db4 <vprintf+0x186>
      } else if(c0 == 'l' && c1 == 'x'){
    4d18:	07800793          	li	a5,120
    4d1c:	0ef68263          	beq	a3,a5,4e00 <vprintf+0x1d2>
        putc(fd, '%');
    4d20:	02500593          	li	a1,37
    4d24:	855a                	mv	a0,s6
    4d26:	e43ff0ef          	jal	4b68 <putc>
        putc(fd, c0);
    4d2a:	85ca                	mv	a1,s2
    4d2c:	855a                	mv	a0,s6
    4d2e:	e3bff0ef          	jal	4b68 <putc>
      state = 0;
    4d32:	4981                	li	s3,0
    4d34:	b791                	j	4c78 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4d36:	008b8913          	addi	s2,s7,8
    4d3a:	4685                	li	a3,1
    4d3c:	4629                	li	a2,10
    4d3e:	000ba583          	lw	a1,0(s7)
    4d42:	855a                	mv	a0,s6
    4d44:	e43ff0ef          	jal	4b86 <printint>
        i += 1;
    4d48:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    4d4a:	8bca                	mv	s7,s2
      state = 0;
    4d4c:	4981                	li	s3,0
        i += 1;
    4d4e:	b72d                	j	4c78 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4d50:	06400793          	li	a5,100
    4d54:	02f60763          	beq	a2,a5,4d82 <vprintf+0x154>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4d58:	07500793          	li	a5,117
    4d5c:	06f60963          	beq	a2,a5,4dce <vprintf+0x1a0>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4d60:	07800793          	li	a5,120
    4d64:	faf61ee3          	bne	a2,a5,4d20 <vprintf+0xf2>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    4d74:	855a                	mv	a0,s6
    4d76:	e11ff0ef          	jal	4b86 <printint>
        i += 2;
    4d7a:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    4d7c:	8bca                	mv	s7,s2
      state = 0;
    4d7e:	4981                	li	s3,0
        i += 2;
    4d80:	bde5                	j	4c78 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4d82:	008b8913          	addi	s2,s7,8
    4d86:	4685                	li	a3,1
    4d88:	4629                	li	a2,10
    4d8a:	000ba583          	lw	a1,0(s7)
    4d8e:	855a                	mv	a0,s6
    4d90:	df7ff0ef          	jal	4b86 <printint>
        i += 2;
    4d94:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    4d96:	8bca                	mv	s7,s2
      state = 0;
    4d98:	4981                	li	s3,0
        i += 2;
    4d9a:	bdf9                	j	4c78 <vprintf+0x4a>
    ...
    4da8:	855a                	mv	a0,s6
    4daa:	dddff0ef          	jal	4b86 <printint>
    4dae:	8bca                	mv	s7,s2
      state = 0;
    4db0:	4981                	li	s3,0
    4db2:	b5d9                	j	4c78 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    4dc0:	855a                	mv	a0,s6
    4dc2:	dc5ff0ef          	jal	4b86 <printint>
        i += 1;
    ...
    4dca:	4981                	li	s3,0
        i += 1;
    4dcc:	b575                	j	4c78 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    4dce:	008b8913          	addi	s2,s7,8
    4dd2:	4681                	li	a3,0
    4dd4:	4629                	li	a2,10
    4dd6:	000ba583          	lw	a1,0(s7)
    4dda:	855a                	mv	a0,s6
    4ddc:	dabff0ef          	jal	4b86 <printint>
        i += 2;
    4de0:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    4de2:	8bca                	mv	s7,s2
      state = 0;
    4de4:	4981                	li	s3,0
        i += 2;
    4de6:	bd49                	j	4c78 <vprintf+0x4a>
    ...
    4df4:	855a                	mv	a0,s6
    4df6:	d91ff0ef          	jal	4b86 <printint>
    4dfa:	8bca                	mv	s7,s2
      state = 0;
    4dfc:	4981                	li	s3,0
    4dfe:	bdad                	j	4c78 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4e00:	008b8913          	addi	s2,s7,8
    4e04:	4681                	li	a3,0
    4e06:	4641                	li	a2,16
    4e08:	000ba583          	lw	a1,0(s7)
    4e0c:	855a                	mv	a0,s6
    4e0e:	d79ff0ef          	jal	4b86 <printint>
        i += 1;
    ...
    4e16:	4981                	li	s3,0
        i += 1;
    4e18:	b585                	j	4c78 <vprintf+0x4a>
    4e1a:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    4e1c:	008b8d13          	addi	s10,s7,8
    4e20:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    4e24:	03000593          	li	a1,48
    4e28:	855a                	mv	a0,s6
    4e2a:	d3fff0ef          	jal	4b68 <putc>
  putc(fd, 'x');
    4e2e:	07800593          	li	a1,120
    4e32:	855a                	mv	a0,s6
    4e34:	d35ff0ef          	jal	4b68 <putc>
    4e38:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4e3a:	00002b97          	auipc	s7,0x2
    4e3e:	666b8b93          	addi	s7,s7,1638 # 74a0 <digits>
    4e42:	03c9d793          	srli	a5,s3,0x3c
    4e46:	97de                	add	a5,a5,s7
    4e48:	0007c583          	lbu	a1,0(a5)
    4e4c:	855a                	mv	a0,s6
    4e4e:	d1bff0ef          	jal	4b68 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    4e52:	0992                	slli	s3,s3,0x4
    4e54:	397d                	addiw	s2,s2,-1
    4e56:	fe0916e3          	bnez	s2,4e42 <vprintf+0x214>
        printptr(fd, va_arg(ap, uint64));
    4e5a:	8bea                	mv	s7,s10
      state = 0;
    4e5c:	4981                	li	s3,0
    4e5e:	6d02                	ld	s10,0(sp)
    4e60:	bd21                	j	4c78 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    4e62:	008b8993          	addi	s3,s7,8
    4e66:	000bb903          	ld	s2,0(s7)
    4e6a:	00090f63          	beqz	s2,4e88 <vprintf+0x25a>
        for(; *s; s++)
    4e6e:	00094583          	lbu	a1,0(s2)
    4e72:	c195                	beqz	a1,4e96 <vprintf+0x268>
          putc(fd, *s);
    4e74:	855a                	mv	a0,s6
    4e76:	cf3ff0ef          	jal	4b68 <putc>
        for(; *s; s++)
    4e7a:	0905                	addi	s2,s2,1
    4e7c:	00094583          	lbu	a1,0(s2)
    4e80:	f9f5                	bnez	a1,4e74 <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
    4e82:	8bce                	mv	s7,s3
      state = 0;
    4e84:	4981                	li	s3,0
    4e86:	bbcd                	j	4c78 <vprintf+0x4a>
          s = "(null)";
    4e88:	00002917          	auipc	s2,0x2
    4e8c:	59890913          	addi	s2,s2,1432 # 7420 <malloc+0x248c>
        for(; *s; s++)
    4e90:	02800593          	li	a1,40
    4e94:	b7c5                	j	4e74 <vprintf+0x246>
        if((s = va_arg(ap, char*)) == 0)
    4e96:	8bce                	mv	s7,s3
      state = 0;
    4e98:	4981                	li	s3,0
    4e9a:	bbf9                	j	4c78 <vprintf+0x4a>
    4e9c:	64a6                	ld	s1,72(sp)
    4e9e:	79e2                	ld	s3,56(sp)
    4ea0:	7a42                	ld	s4,48(sp)
    4ea2:	7aa2                	ld	s5,40(sp)
    4ea4:	7b02                	ld	s6,32(sp)
    4ea6:	6be2                	ld	s7,24(sp)
    4ea8:	6c42                	ld	s8,16(sp)
    4eaa:	6ca2                	ld	s9,8(sp)
    }
  }
}
    4eac:	60e6                	ld	ra,88(sp)
    4eae:	6446                	ld	s0,80(sp)
    4eb0:	6906                	ld	s2,64(sp)
    4eb2:	6125                	addi	sp,sp,96
    4eb4:	8082                	ret

0000000000004eb6 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    4eb6:	715d                	addi	sp,sp,-80
    4eb8:	ec06                	sd	ra,24(sp)
    4eba:	e822                	sd	s0,16(sp)
    4ebc:	1000                	addi	s0,sp,32
    4ebe:	e010                	sd	a2,0(s0)
    4ec0:	e414                	sd	a3,8(s0)
    4ec2:	e818                	sd	a4,16(s0)
    4ec4:	ec1c                	sd	a5,24(s0)
    4ec6:	03043023          	sd	a6,32(s0)
    4eca:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    4ece:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    4ed2:	8622                	mv	a2,s0
    4ed4:	d5bff0ef          	jal	4c2e <vprintf>
}
    4ed8:	60e2                	ld	ra,24(sp)
    4eda:	6442                	ld	s0,16(sp)
    4edc:	6161                	addi	sp,sp,80
    4ede:	8082                	ret

0000000000004ee0 <printf>:

void
printf(const char *fmt, ...)
{
    4ee0:	711d                	addi	sp,sp,-96
    4ee2:	ec06                	sd	ra,24(sp)
    4ee4:	e822                	sd	s0,16(sp)
    4ee6:	1000                	addi	s0,sp,32
    4ee8:	e40c                	sd	a1,8(s0)
    4eea:	e810                	sd	a2,16(s0)
    4eec:	ec14                	sd	a3,24(s0)
    4eee:	f018                	sd	a4,32(s0)
    4ef0:	f41c                	sd	a5,40(s0)
    4ef2:	03043823          	sd	a6,48(s0)
    4ef6:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    4efa:	00840613          	addi	a2,s0,8
    4efe:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    4f02:	85aa                	mv	a1,a0
    4f04:	4505                	li	a0,1
    4f06:	d29ff0ef          	jal	4c2e <vprintf>
}
    4f0a:	60e2                	ld	ra,24(sp)
    4f0c:	6442                	ld	s0,16(sp)
    4f0e:	6125                	addi	sp,sp,96
    4f10:	8082                	ret

0000000000004f12 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    4f12:	1141                	addi	sp,sp,-16
    4f14:	e422                	sd	s0,8(sp)
    4f16:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    4f18:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4f1c:	00004797          	auipc	a5,0x4
    4f20:	5347b783          	ld	a5,1332(a5) # 9450 <freep>
    4f24:	a02d                	j	4f4e <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    4f26:	4618                	lw	a4,8(a2)
    4f28:	9f2d                	addw	a4,a4,a1
    4f2a:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    4f2e:	6398                	ld	a4,0(a5)
    4f30:	6310                	ld	a2,0(a4)
    4f32:	a83d                	j	4f70 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    4f34:	ff852703          	lw	a4,-8(a0)
    4f38:	9f31                	addw	a4,a4,a2
    4f3a:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    4f3c:	ff053683          	ld	a3,-16(a0)
    4f40:	a091                	j	4f84 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4f42:	6398                	ld	a4,0(a5)
    4f44:	00e7e463          	bltu	a5,a4,4f4c <free+0x3a>
    4f48:	00e6ea63          	bltu	a3,a4,4f5c <free+0x4a>
{
    4f4c:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4f4e:	fed7fae3          	bgeu	a5,a3,4f42 <free+0x30>
    4f52:	6398                	ld	a4,0(a5)
    4f54:	00e6e463          	bltu	a3,a4,4f5c <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    4f58:	fee7eae3          	bltu	a5,a4,4f4c <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    4f5c:	ff852583          	lw	a1,-8(a0)
    4f60:	6390                	ld	a2,0(a5)
    4f62:	02059813          	slli	a6,a1,0x20
    4f66:	01c85713          	srli	a4,a6,0x1c
    4f6a:	9736                	add	a4,a4,a3
    4f6c:	fae60de3          	beq	a2,a4,4f26 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    4f70:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    4f74:	4790                	lw	a2,8(a5)
    4f76:	02061593          	slli	a1,a2,0x20
    4f7a:	01c5d713          	srli	a4,a1,0x1c
    4f7e:	973e                	add	a4,a4,a5
    4f80:	fae68ae3          	beq	a3,a4,4f34 <free+0x22>
    p->s.ptr = bp->s.ptr;
    4f84:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    4f86:	00004717          	auipc	a4,0x4
    4f8a:	4cf73523          	sd	a5,1226(a4) # 9450 <freep>
}
    4f8e:	6422                	ld	s0,8(sp)
    4f90:	0141                	addi	sp,sp,16
    4f92:	8082                	ret

0000000000004f94 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4fa0:	02051493          	slli	s1,a0,0x20
    4fa4:	9081                	srli	s1,s1,0x20
    4fa6:	04bd                	addi	s1,s1,15
    4fa8:	8091                	srli	s1,s1,0x4
    4faa:	0014899b          	addiw	s3,s1,1
    4fae:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    4fb0:	00004517          	auipc	a0,0x4
    4fb4:	4a053503          	ld	a0,1184(a0) # 9450 <freep>
    4fb8:	c915                	beqz	a0,4fec <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4fba:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    4fbc:	4798                	lw	a4,8(a5)
    4fbe:	08977a63          	bgeu	a4,s1,5052 <malloc+0xbe>
    4fc2:	f04a                	sd	s2,32(sp)
    4fc4:	e852                	sd	s4,16(sp)
    4fc6:	e456                	sd	s5,8(sp)
    4fc8:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    4fca:	8a4e                	mv	s4,s3
    4fcc:	0009871b          	sext.w	a4,s3
    4fd0:	6685                	lui	a3,0x1
    4fd2:	00d77363          	bgeu	a4,a3,4fd8 <malloc+0x44>
    4fd6:	6a05                	lui	s4,0x1
    4fd8:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    4fdc:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    4fe0:	00004917          	auipc	s2,0x4
    4fe4:	47090913          	addi	s2,s2,1136 # 9450 <freep>
  if(p == (char*)-1)
    4fe8:	5afd                	li	s5,-1
    4fea:	a081                	j	502a <malloc+0x96>
    4fec:	f04a                	sd	s2,32(sp)
    4fee:	e852                	sd	s4,16(sp)
    4ff0:	e456                	sd	s5,8(sp)
    4ff2:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    4ff4:	0000b797          	auipc	a5,0xb
    4ff8:	c8478793          	addi	a5,a5,-892 # fc78 <base>
    4ffc:	00004717          	auipc	a4,0x4
    5000:	44f73a23          	sd	a5,1108(a4) # 9450 <freep>
    5004:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5006:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    500a:	b7c1                	j	4fca <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    500c:	6398                	ld	a4,0(a5)
    500e:	e118                	sd	a4,0(a0)
    5010:	a8a9                	j	506a <malloc+0xd6>
  hp->s.size = nu;
    5012:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5016:	0541                	addi	a0,a0,16
    5018:	efbff0ef          	jal	4f12 <free>
  return freep;
    501c:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5020:	c12d                	beqz	a0,5082 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5022:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5024:	4798                	lw	a4,8(a5)
    5026:	02977263          	bgeu	a4,s1,504a <malloc+0xb6>
    if(p == freep)
    502a:	00093703          	ld	a4,0(s2)
    502e:	853e                	mv	a0,a5
    5030:	fef719e3          	bne	a4,a5,5022 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    5034:	8552                	mv	a0,s4
    5036:	ad3ff0ef          	jal	4b08 <sbrk>
  if(p == (char*)-1)
    503a:	fd551ce3          	bne	a0,s5,5012 <malloc+0x7e>
        return 0;
    503e:	4501                	li	a0,0
    5040:	7902                	ld	s2,32(sp)
    5042:	6a42                	ld	s4,16(sp)
    5044:	6aa2                	ld	s5,8(sp)
    5046:	6b02                	ld	s6,0(sp)
    5048:	a03d                	j	5076 <malloc+0xe2>
    504a:	7902                	ld	s2,32(sp)
    504c:	6a42                	ld	s4,16(sp)
    504e:	6aa2                	ld	s5,8(sp)
    5050:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    5052:	fae48de3          	beq	s1,a4,500c <malloc+0x78>
        p->s.size -= nunits;
    5056:	4137073b          	subw	a4,a4,s3
    505a:	c798                	sw	a4,8(a5)
        p += p->s.size;
    505c:	02071693          	slli	a3,a4,0x20
    5060:	01c6d713          	srli	a4,a3,0x1c
    5064:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5066:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    506a:	00004717          	auipc	a4,0x4
    506e:	3ea73323          	sd	a0,998(a4) # 9450 <freep>
      return (void*)(p + 1);
    5072:	01078513          	addi	a0,a5,16
  }
}
    5076:	70e2                	ld	ra,56(sp)
    5078:	7442                	ld	s0,48(sp)
    507a:	74a2                	ld	s1,40(sp)
    507c:	69e2                	ld	s3,24(sp)
    507e:	6121                	addi	sp,sp,64
    5080:	8082                	ret
    5082:	7902                	ld	s2,32(sp)
    5084:	6a42                	ld	s4,16(sp)
    5086:	6aa2                	ld	s5,8(sp)
    5088:	6b02                	ld	s6,0(sp)
    508a:	b7f5                	j	5076 <malloc+0xe2>
