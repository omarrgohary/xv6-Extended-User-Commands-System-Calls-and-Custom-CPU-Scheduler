...
int main(int argc, char *argv[]) {
  ...
  16:	8ee50513          	addi	a0,a0,-1810 # 900 <malloc+0x104>
  1a:	72e000ef          	jal	748 <printf>
    exit(1);
  1e:	4505                	li	a0,1
  20:	2c8000ef          	jal	2e8 <exit>
  24:	e426                	sd	s1,8(sp)
  26:	e04a                	sd	s2,0(sp)
  28:	84ae                	mv	s1,a1
  }
  ...
  2a:	4581                	li	a1,0
  2c:	6488                	ld	a0,8(s1)
  2e:	2fa000ef          	jal	328 <open>
  32:	892a                	mv	s2,a0
  if(fd >= 0) {
  34:	00054f63          	bltz	a0,52 <main+0x52>
    // File exists, raise error
    printf("Error: file '%s' already exists\n", argv[1]);
  38:	648c                	ld	a1,8(s1)
  3a:	00001517          	auipc	a0,0x1
  3e:	8e650513          	addi	a0,a0,-1818 # 920 <malloc+0x124>
  42:	706000ef          	jal	748 <printf>
    close(fd);
  46:	854a                	mv	a0,s2
  48:	2c8000ef          	jal	310 <close>
    exit(1);
  4c:	4505                	li	a0,1
  4e:	29a000ef          	jal	2e8 <exit>
  }

  // File does not exist, create it
  fd = open(argv[1], O_CREATE | O_WRONLY);
  52:	20100593          	li	a1,513
  56:	6488                	ld	a0,8(s1)
  58:	2d0000ef          	jal	328 <open>
  if(fd < 0) {
  5c:	00054763          	bltz	a0,6a <main+0x6a>
  ...
  close(fd);
  60:	2b0000ef          	jal	310 <close>
  exit(0);
  64:	4501                	li	a0,0
  66:	282000ef          	jal	2e8 <exit>
    printf("Error: could not create file '%s'\n", argv[1]);
  6a:	648c                	ld	a1,8(s1)
  6c:	00001517          	auipc	a0,0x1
  70:	8dc50513          	addi	a0,a0,-1828 # 948 <malloc+0x14c>
  74:	6d4000ef          	jal	748 <printf>
    exit(1);
  78:	4505                	li	a0,1
...
gets(char *buf, int max)
{
 ...
 16e:	0344d663          	bge	s1,s4,19a <gets+0x52>
    cc = read(0, &c, 1);
 172:	4605                	li	a2,1
 174:	faf40593          	addi	a1,s0,-81
 178:	4501                	li	a0,0
 17a:	186000ef          	jal	300 <read>
    if(cc < 1)
 17e:	00a05e63          	blez	a0,19a <gets+0x52>
    buf[i++] = c;
 182:	faf44783          	lbu	a5,-81(s0)
 186:	00f90023          	sb	a5,0(s2)
    if(c == '\n' || c == '\r')
 18a:	01578763          	beq	a5,s5,198 <gets+0x50>
 18e:	0905                	addi	s2,s2,1
 190:	fd679de3          	bne	a5,s6,16a <gets+0x22>
    buf[i++] = c;
 194:	89a6                	mv	s3,s1
 196:	a011                	j	19a <gets+0x52>
 198:	89a6                	mv	s3,s1
      break;
  }
  buf[i] = '\0';
...
stat(const char *n, struct stat *st)
{
 ...
 1d0:	84aa                	mv	s1,a0
  ...
  r = fstat(fd, st);
 1d2:	85ca                	mv	a1,s2
 1d4:	16c000ef          	jal	340 <fstat>
 1d8:	892a                	mv	s2,a0
  close(fd);
 1da:	8526                	mv	a0,s1
 1dc:	134000ef          	jal	310 <close>
  return r;
 1e0:	64a2                	ld	s1,8(sp)
}
 1e2:	854a                	mv	a0,s2
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 25a:	fed70fa3          	sb	a3,-1(a4)
    while(n-- > 0)
 25e:	fef71ae3          	bne	a4,a5,252 <memmove+0x18>
    src += n;
    while(n-- > 0)
      *--dst = *--src;
  }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 410:	56c50513          	addi	a0,a0,1388 # 978 <digits>
 414:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a6:	2d6b8b93          	addi	s7,s7,726 # 978 <digits>
 ...
 6f4:	28090913          	addi	s2,s2,640 # 970 <malloc+0x174>
        for(; *s; s++)
